...
(function(exports) {
      ...
      return function (backend) {
          return function (k) {
              return Control_Monad_Cont_Trans.runContT(Control_Monad_Except_Trans.runExceptT(Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Cont_Trans.monadContT(Control_Monad_Eff.monadEff)))(Try_Gist.getGistById(id_))(function (gi) {
                  ...
                  throw new Error("Failed pattern match at Main line 320, column 5 - line 324, column 40: " + [ v.constructor.name ]);
              });
          };
      };
  };
  var withSession = function (sessionId) {
      return function (k) {
          return function __do() {
              ...
              throw new Error("Failed pattern match at Main line 344, column 3 - line 350, column 29: " + [ v.constructor.name ]);
          };
      };
  };
      ...
      return function __do() {
          ...
          return Control_Applicative.when(Control_Monad_Eff.applicativeEff)(v1)(function __do() {
              ...
              return Control_Monad_Cont_Trans.runContT(Control_Monad_Except_Trans.runExceptT(Try_Gist.uploadGist(v2)))(function (v3) {
                  ...
                  throw new Error("Failed pattern match at Main line 384, column 7 - line 390, column 71: " + [ v3.constructor.name ]);
              })();
          })();
      };
  };
                  ...
                  return function __do() {
                      ...
                      if (res_.value0 instanceof Data_Either.Right && res_.value0.value0 instanceof Try_API.CompileSuccess) {
                          ...
                          return Control_Monad_Cont_Trans.runContT(Control_Monad_Except_Trans.runExceptT(v.getBundle))(function (v3) {
                              ...
                              throw new Error("Failed pattern match at Main line 187, column 22 - line 199, column 51: " + [ v3.constructor.name ]);
                          })();
                      };
                      if (res_.value0 instanceof Data_Either.Right && res_.value0.value0 instanceof Try_API.CompileFailed) {
                          ...
                          throw new Error("Failed pattern match at Main line 201, column 13 - line 222, column 53: " + [ res_.value0.value0.value0.error.constructor.name ]);
                      };
                      ...
                      throw new Error("Failed pattern match at Main line 181, column 9 - line 225, column 58: " + [ res_.value0.constructor.name ]);
                  };
              };
              throw new Error("Failed pattern match at Main line 176, column 5 - line 225, column 58: " + [ res_.constructor.name ]);
          })();
      };
  };
  ...
  var loadOptions = function (bc) {
      return function __do() {
          ...
          throw new Error("Failed pattern match at Main line 427, column 3 - line 429, column 61: " + [ v3.constructor.name ]);
      };
  };
  ...
  var cacheCurrentCode = function (v) {
      return function __do() {
          ...
          throw new Error("Failed pattern match at Main line 359, column 3 - line 365, column 1: " + [ v1.constructor.name ]);
      };
  };
