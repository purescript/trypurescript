...
(function(exports) {
  ...
  var uploadGistContT = function (content) {
      return function (k) {
          return Control_Monad_Eff_Uncurried.runEffFn3($foreign.uploadGist)(content)(Control_Monad_Eff_Uncurried.mkEffFn1(function ($121) {
              return k(Data_Either.Right.create($121));
          }))(Control_Monad_Eff_Uncurried.mkEffFn1(function ($122) {
              return k(Data_Either.Left.create($122));
          }));
      };
  };
  ...
  var tryLoadFileFromGistContT = function (gi) {
      return function (filename) {
          return function (k) {
              return Control_Monad_Eff_Uncurried.runEffFn4($foreign.tryLoadFileFromGist)(gi)(filename)(Control_Monad_Eff_Uncurried.mkEffFn1(function ($123) {
  ...
  var randomGuid = (function () {
      ...
      var s4 = Data_Functor.map(Control_Monad_Eff.functorEff)(function ($125) {
          return padLeft(Data_Int.toStringAs(Data_Int.hexadecimal)($125));
  ...
  var getValueMaybe = function ($126) {
      return Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Nullable.toMaybe)(Control_Monad_Eff_Uncurried.runEffFn1($foreign.getValue)($126));
  };
  var getQueryParams = (function () {
      ...
      var breakQueryString = function ($127) {
          return (function ($128) {
              return Data_StrMap.fromFoldable(Data_Foldable.foldableArray)(Data_Array.catMaybes(Data_Functor.map(Data_Functor.functorArray)(function ($129) {
                  return parseQueryTerm(Data_String.split(Data_Newtype.wrap(Data_String.newtypePattern)("="))($129));
              })($128)));
          })(Data_String.split(Data_Newtype.wrap(Data_String.newtypePattern)("&"))(Data_String.drop(1)($127)));
      };
  ...
  var setupSession = Control_Monad_Eff_Uncurried.mkEffFn1(function (k) {
      return function __do() {
          ...
          throw new Error("Failed pattern match at Main line 217, column 3 - line 221, column 1: " + [ v.constructor.name ]);
      };
  });
  ...
  var getGistByIdContT = function (id_) {
      return function (k) {
          return Control_Monad_Eff_Uncurried.runEffFn3($foreign.getGistById)(id_)(Control_Monad_Eff_Uncurried.mkEffFn1(function ($130) {
              return k(Data_Either.Right.create($130));
          }))(Control_Monad_Eff_Uncurried.mkEffFn1(function ($131) {
              return k(Data_Either.Left.create($131));
          }));
      };
  };
  var getContT = function (uri) {
      return function (k) {
          return Control_Monad_Eff_Uncurried.runEffFn3($foreign.get)(uri)(Control_Monad_Eff_Uncurried.mkEffFn1(function ($132) {
  ...
  var publishNewGist = function __do() {
      ...
      return Control_Applicative.when(Control_Monad_Eff.applicativeEff)(v)(function __do() {
          ...
          return Control_Monad_Cont_Trans.runContT(Control_Monad_Except_Trans.runExceptT(uploadGistContT(v1)))(function (v2) {
              ...
              throw new Error("Failed pattern match at Main line 204, column 7 - line 211, column 43: " + [ v2.constructor.name ]);
          })();
      })();
  };
  ...
  var ordBackend = new Data_Ord.Ord(function () {
      ...
      return function (y) {
          ...
          throw new Error("Failed pattern match at Main line 405, column 8 - line 405, column 42: " + [ x.constructor.name, y.constructor.name ]);
      };
  });
  ...
  var cacheCurrentCode = function __do() {
      ...
      throw new Error("Failed pattern match at Main line 145, column 3 - line 152, column 1: " + [ v.constructor.name ]);
  };
          ...
          var onComplete = function (dictPartial) {
              return function (v1) {
                  ...
                  return __unused(dictPartial)((function () {
                      ...
                      throw new Error("Failed pattern match at Main line 87, column 9 - line 92, column 33: " + [ v1.constructor.name ]);
                  })());
              };
          };
  ...
  var getBackend = function (v) {
      ...
      throw new Error("Failed pattern match at Main line 407, column 1 - line 407, column 39: " + [ v.constructor.name ]);
  };
  var backendToString = function (v) {
      ...
      throw new Error("Failed pattern match at Main line 396, column 1 - line 396, column 37: " + [ v.constructor.name ]);
  };
  var backendFromString = function (dictPartial) {
      return function (v) {
          ...
          return __unused(dictPartial)((function () {
              ...
              throw new Error("Failed pattern match at Main line 388, column 1 - line 388, column 50: " + [ v.constructor.name ]);
          })());
      };
  };
  ...
  var loadOptions = Control_Monad_Eff_Uncurried.mkEffFn1(function (v) {
      return function __do() {
          ...
          (function () {
              ...
              throw new Error("Failed pattern match at Main line 351, column 3 - line 353, column 47: " + [ v4.constructor.name ]);
          })()();
  ...
  var setupEditor = Control_Monad_Eff_Uncurried.mkEffFn1(function (backend) {
      return function __do() {
          ...
          Control_Monad_Eff_Uncurried.runEffFn1($foreign.setupEditorWith)(backend)();
          return cacheCurrentCode();
      };
  });
  var loadFromGist = Control_Monad_Eff_Uncurried.mkEffFn2(function (id_) {
      return function (backend) {
          return Control_Monad_Cont_Trans.runContT(Control_Monad_Except_Trans.runExceptT(Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Cont_Trans.monadContT(Control_Monad_Eff.monadEff)))(getGistByIdContT(id_))(function (gi) {
              ...
              throw new Error("Failed pattern match at Main line 105, column 5 - line 111, column 38: " + [ v.constructor.name ]);
          });
      };
  });
  var withSession = Control_Monad_Eff_Uncurried.mkEffFn1(function (sessionId) {
      return function __do() {
          ...
          if (v instanceof Data_Maybe.Nothing) {
              var v1 = Data_Functor.map(Control_Monad_Eff.functorEff)(function ($134) {
                  return getBackendFromString(Data_Maybe.fromMaybe("core")($134));
          ...
          throw new Error("Failed pattern match at Main line 116, column 3 - line 121, column 37: " + [ v.constructor.name ]);
      };
  });
