...
(function(exports) {
  ...
  var loadOptions = function (bc) {
      return function __do() {
          ...
          throw new Error("Failed pattern match at Main line 378, column 3 - line 380, column 61: " + [ v3.constructor.name ]);
      };
  };
      ...
      return function (backend) {
          return function (k) {
              return Control_Monad_Cont_Trans.runContT(Control_Monad_Except_Trans.runExceptT(Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Cont_Trans.monadContT(Control_Monad_Eff.monadEff)))(Try_Gist.getGistById(id_))(function (gi) {
                  ...
                  throw new Error("Failed pattern match at Main line 218, column 5 - line 224, column 18: " + [ v.constructor.name ]);
              });
          };
      };
  };
  var withSession = function (sessionId) {
      return function (k) {
          return function __do() {
              ...
              if (v instanceof Data_Maybe.Just) {
                  return k(Try_API.getBackendConfigFromString(v.value0))();
              };
              if (v instanceof Data_Maybe.Nothing) {
              ...
              throw new Error("Failed pattern match at Main line 243, column 3 - line 248, column 29: " + [ v.constructor.name ]);
          };
      };
  };
  ...
  var publishNewGist = function __do() {
      ...
      return Control_Applicative.when(Control_Monad_Eff.applicativeEff)(v)(function __do() {
          ...
          return Control_Monad_Cont_Trans.runContT(Control_Monad_Except_Trans.runExceptT(Try_Gist.uploadGist(v1)))(function (v2) {
              ...
              throw new Error("Failed pattern match at Main line 290, column 7 - line 297, column 43: " + [ v2.constructor.name ]);
          })();
      })();
  };

  // | Get the backend configuration from whatever is selected in the menu.
  var getBackendConfigFromView = Data_Functor.map(Control_Monad_Eff.functorEff)(Try_API.getBackendConfigFromString)(getBackendNameFromView);
  ...
  var compile = function (v) {
      return function __do() {
          ...
          return Control_Monad_Cont_Trans.runContT(Control_Monad_Except_Trans.runExceptT(v.compile(v3)))(function (res_) {
              ...
              if (res_ instanceof Data_Either.Right) {
                  return function __do() {
                      ...
                      if (res_.value0 instanceof Data_Either.Right && res_.value0.value0 instanceof Try_API.CompileSuccess) {
                          ...
                          return Control_Monad_Cont_Trans.runContT(Control_Monad_Except_Trans.runExceptT(v.getBundle))(function (v5) {
                              if (v5 instanceof Data_Either.Left) {
                                  return Control_Monad_Eff_Console.error("Unable to retrieve JS bundle: " + v5.value0);
                              };
                              if (v5 instanceof Data_Either.Right) {
                                  return execute(res_.value0.value0.value0.js)(v5.value0)(v);
                              };
                              throw new Error("Failed pattern match at Main line 76, column 22 - line 78, column 65: " + [ v5.constructor.name ]);
                          })();
                      };
                      if (res_.value0 instanceof Data_Either.Right && res_.value0.value0 instanceof Try_API.CompileFailed) {
                          ...
                          throw new Error("Failed pattern match at Main line 80, column 13 - line 101, column 53: " + [ res_.value0.value0.value0.error.constructor.name ]);
                      };
                      ...
                      throw new Error("Failed pattern match at Main line 70, column 9 - line 104, column 58: " + [ res_.value0.constructor.name ]);
                  };
              };
              throw new Error("Failed pattern match at Main line 65, column 5 - line 104, column 58: " + [ res_.constructor.name ]);
          })();
      };
  };
  ...
  var cacheCurrentCode = function __do() {
      ...
      throw new Error("Failed pattern match at Main line 254, column 3 - line 261, column 1: " + [ v.constructor.name ]);
  };
  ...
  var setupEditor = function (bc) {
      return function __do() {
          ...
          setupBackendMenu(bc)();
          (function __do() {
              var $145 = Control_Bind.bind(Control_Monad_Eff.bindEff)(Control_Monad_Eff_JQuery.select("#code_textarea"))(Control_Monad_Eff_JQuery_Extras.getValueMaybe)();
              return Control_Monad_Eff_Uncurried.runEffFn1($foreign.setEditorContent)(Data_Foldable.fold(Data_Foldable.foldableMaybe)(Data_Monoid.monoidString)($145))();
          })();
