...
(function(exports) {
  ...
  var parseDeps = function (current) {
      ...
      return function ($32) {
          return Data_Array.mapMaybe(go)(Data_String_Common.split("\x0a")(Data_Newtype.unwrap(Try_Types.newtypeJS)($32)));
      };
  };
      ...
      return function (rootPath) {
          ...
          var load = function (v) {
              return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Cont_Trans.monadContT(Effect.monadEffect)))(Effect_Class.liftEffect(Control_Monad_Except_Trans.monadEffectExceptT(Control_Monad_Cont_Trans.monadEffectContT(Effect_Class.monadEffectEffect)))(getModule(v.name)))(function (v1) {
                  ...
                  throw new Error("Failed pattern match at Try.Loader line 92, column 5 - line 98, column 17: " + [ v1.constructor.name ]);
              });
          };
          ...
          return function (js) {
              ...
              return go(initDeps)(Foreign_Object.empty);
          };
      };
  };
...
(function(exports) {
      ...
      return function (backend) {
          return function (k) {
              return Control_Monad_Cont_Trans.runContT(Control_Monad_Except_Trans.runExceptT(Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Cont_Trans.monadContT(Effect.monadEffect)))(Try_Gist.getGistById(id_))(function (gi) {
                  ...
                  throw new Error("Failed pattern match at Main line 256, column 5 - line 260, column 40: " + [ v.constructor.name ]);
              });
          };
      };
  };
  var withSession = function (sessionId) {
      return function (k) {
          return function __do() {
              ...
              throw new Error("Failed pattern match at Main line 268, column 3 - line 274, column 29: " + [ v.constructor.name ]);
          };
      };
  };
      ...
      return function __do() {
          ...
          return Control_Applicative.when(Effect.applicativeEffect)(v1)(function __do() {
              ...
              return Control_Monad_Cont_Trans.runContT(Control_Monad_Except_Trans.runExceptT(Try_Gist.uploadGist(v2)))(function (v3) {
                  ...
                  throw new Error("Failed pattern match at Main line 297, column 7 - line 303, column 71: " + [ v3.constructor.name ]);
              })();
          })();
      };
  };
  ...
  var execute = function (js) {
      return function (sources) {
          return function (v) {
              ...
              var scripts = Data_String_Common.joinWith("\x0a")([ "(function() {", "  var module = PSRequireShim(" + (json + ")('<file>');"), "  module.main && module.main();", "})();" ]);
  ...
  var loadOptions = function (bc) {
      return function __do() {
          ...
          throw new Error("Failed pattern match at Main line 332, column 3 - line 334, column 61: " + [ v3.constructor.name ]);
      };
  };
  ...
  var cacheCurrentCode = function (v) {
      return function __do() {
          ...
          throw new Error("Failed pattern match at Main line 280, column 3 - line 286, column 1: " + [ v1.constructor.name ]);
      };
  };
