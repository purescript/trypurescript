      ...
      return function (rootPath) {
          ...
          var load = function (v) {
              return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Cont_Trans.monadContT(Effect.monadEffect)))(Effect_Class.liftEffect(Control_Monad_Except_Trans.monadEffectExceptT(Control_Monad_Cont_Trans.monadEffectContT(Effect_Class.monadEffectEffect)))(getModule(v.name)))(function (v1) {
                  ...
                  throw new Error("Failed pattern match at Try.Loader line 90, column 5 - line 96, column 17: " + [ v1.constructor.name ]);
              });
          };
          var go = function (accum) {
              return function (v) {
                  if (v.length === 0) {
                      return Control_Applicative.pure(Control_Monad_Except_Trans.applicativeExceptT(Control_Monad_Cont_Trans.monadContT(Effect.monadEffect)))(accum);
                  };
                  return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Cont_Trans.monadContT(Effect.monadEffect)))(Control_Parallel.parTraverse(Control_Parallel_Class.monadParExceptT(Control_Parallel_Class.monadParParCont(Effect_Class.monadEffectEffect)))(Data_Traversable.traversableArray)(load)(v))(function (v1) {
                      var accum$prime = Foreign_Object.union(accum)(Foreign_Object.fromFoldable(Data_Foldable.foldableArray)(Data_Functor.map(Data_Functor.functorArray)(function (v2) {
                          return new Data_Tuple.Tuple(v2.name, v2.src);
                      })(v1)));
                      return go(accum$prime)(Data_Array.nubBy(Data_Ord.comparing(Data_Ord.ordString)(function (v2) {
                          return v2.name;
          ...
          return function ($35) {
              return go(Foreign_Object.empty)(parseDeps("<file>")($35));
          };
      };
  };
