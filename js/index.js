  ...
  var backendFromString = function (dictPartial) {
      return function (v) {
          ...
          return __unused(dictPartial)((function () {
              ...
              throw new Error("Failed pattern match at Try.Types line 34, column 1 - line 34, column 50: " + [ v.constructor.name ]);
          })());
      };
  };
  exports["JS"] = JS;
...
(function(exports) {
  ...
  var get = function (uri) {
      return function (k) {
          return Control_Monad_Eff_Uncurried.runEffFn3($foreign.get_)(uri)(Control_Monad_Eff_Uncurried.mkEffFn1(function ($53) {
              return k(Data_Either.Right.create($53));
          }))(Control_Monad_Eff_Uncurried.mkEffFn1(function ($54) {
              return k(Data_Either.Left.create($54));
          }));
      };
  };
  ...
  var genericCompileError = new Data_Generic_Rep.Generic(function (x) {
      ...
      throw new Error("Failed pattern match at Try.API line 61, column 8 - line 61, column 62: " + [ x.constructor.name ]);
  }, function (x) {
  ...
  var decodeCompileError = new Data_Foreign_Class.Decode(Data_Foreign_Generic.genericDecode(genericCompileError)(Data_Foreign_Generic_Class.genericDecodeSum(Data_Foreign_Generic_Class.genericDecodeConstructor(new Data_Symbol.IsSymbol(function () {
      ...
      $50.sumEncoding = new Data_Foreign_Generic_Types.TaggedObject({
          tagFieldName: "tag",
          contentsFieldName: "contents",
          constructorTagTransform: Control_Category.id(Control_Category.categoryFn)
      });
  ...
  var compile = function (bc) {
      return function (code) {
          return function (k) {
              return Control_Monad_Eff_Uncurried.runEffFn4($foreign.compile_)(bc)(code)(Control_Monad_Eff_Uncurried.mkEffFn1(function ($55) {
                  return k(Data_Either.Right.create(Control_Monad_Except.runExcept(Data_Foreign_Class.decode(decodeCompileResult)($55))));
              }))(Control_Monad_Eff_Uncurried.mkEffFn1(function ($56) {
                  return k(Data_Either.Left.create($56));
              }));
          };
      };
  };
...
(function(exports) {
  ...
  var tryRestoreCachedCode = function (sessionId) {
      return function __do() {
          ...
          Data_Foldable.for_(Control_Monad_Eff.applicativeEff)(Data_Foldable.foldableMaybe)(v)(function (v1) {
              return function __do() {
                  Control_Bind.bind(Control_Monad_Eff.bindEff)(Control_Monad_Eff_JQuery.select("#backend_" + v1.backend))(Control_Monad_Eff_JQuery_Extras.click)();
  ...
  var loadOptions = function (bc) {
      return function __do() {
          ...
          throw new Error("Failed pattern match at Main line 416, column 3 - line 418, column 61: " + [ v3.constructor.name ]);
      };
  };
      ...
      return function (backend) {
          return function (k) {
              return Control_Monad_Cont_Trans.runContT(Control_Monad_Except_Trans.runExceptT(Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Cont_Trans.monadContT(Control_Monad_Eff.monadEff)))(Try_Gist.getGistById(id_))(function (gi) {
                  ...
                  throw new Error("Failed pattern match at Main line 256, column 5 - line 262, column 18: " + [ v.constructor.name ]);
              });
          };
      };
  };
  ...
  var getBackendNameFromView = Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Maybe.fromMaybe("core"))(function __do() {
      var v = Control_Monad_Eff_JQuery.select("input[name=backend_inputs]")();
      var v1 = Control_Monad_Eff_JQuery_Extras.filter(v)(":checked")();
      return Control_Monad_Eff_JQuery_Extras.getValueMaybe(v1)();
  });
  var publishNewGist = function __do() {
      ...
      return Control_Applicative.when(Control_Monad_Eff.applicativeEff)(v)(function __do() {
          var v1 = Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Foldable.fold(Data_Foldable.foldableMaybe)(Data_Monoid.monoidString))(Control_Bind.bind(Control_Monad_Eff.bindEff)(Control_Monad_Eff_JQuery.select("#code_textarea"))(Control_Monad_Eff_JQuery_Extras.getValueMaybe))();
          return Control_Monad_Cont_Trans.runContT(Control_Monad_Except_Trans.runExceptT(Try_Gist.uploadGist(v1)))(function (v2) {
              if (v2 instanceof Data_Either.Left) {
                  return function __do() {
                      Control_Bind.bind(Control_Monad_Eff.bindEff)(DOM_HTML.window)(DOM_HTML_Window.alert("Failed to JQuery.create gist"))();
                      return Control_Monad_Eff_Console.error("Failed to JQuery.create gist: " + v2.value0)();
                  };
              };
              if (v2 instanceof Data_Either.Right) {
                  return function __do() {
                      var v3 = getBackendNameFromView();
                      Try_QueryString.setQueryString("gist")(v2.value0)();
                      return Try_QueryString.setQueryString("backend")(v3)();
                  };
              };
              throw new Error("Failed pattern match at Main line 328, column 7 - line 335, column 43: " + [ v2.constructor.name ]);
          })();
      })();
  };
  ...
  var defaultBundleAndExecute = function (js) {
      return function (v) {
          return Control_Monad_Cont_Trans.runContT(Control_Monad_Except_Trans.runExceptT(Try_API.get(v.endpoint + "/bundle")))(function (v1) {
              ...
              throw new Error("Failed pattern match at Main line 206, column 5 - line 208, column 48: " + [ v1.constructor.name ]);
          });
      };
  };
  var compile = function (v) {
      return function __do() {
          var v1 = Control_Monad_Eff_JQuery.select("#column2")();
          Control_Monad_Eff_JQuery_Extras.empty(v1)();
          var v2 = Control_Monad_Eff_JQuery.create("<div>")();
          Control_Monad_Eff_JQuery.addClass("loading")(v2)();
          Control_Monad_Eff_JQuery.appendText("Loading...")(v2)();
          Control_Monad_Eff_JQuery.append(v2)(v1)();
          var v3 = Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Foldable.fold(Data_Foldable.foldableMaybe)(Data_Monoid.monoidString))(Control_Bind.bind(Control_Monad_Eff.bindEff)(Control_Monad_Eff_JQuery.select("#code_textarea"))(Control_Monad_Eff_JQuery_Extras.getValueMaybe))();
          return Control_Monad_Cont_Trans.runContT(Control_Monad_Except_Trans.runExceptT(Try_API.compile(v)(v3)))(function (res_) {
              ...
              if (res_ instanceof Data_Either.Right) {
                  return function __do() {
                      ...
                      if (res_.value0 instanceof Data_Either.Right && res_.value0.value0 instanceof Try_API.CompileSuccess) {
                          ...
                          return v.bundleAndExecute(res_.value0.value0.value0.js)(v)();
                      };
                      if (res_.value0 instanceof Data_Either.Right && res_.value0.value0 instanceof Try_API.CompileFailed) {
                          if (res_.value0.value0.value0.error instanceof Try_API.CompilerErrors) {
                              Control_Monad_Eff_JQuery_Extras.empty(v1)();
                              return Data_FoldableWithIndex.forWithIndex_(Control_Monad_Eff.applicativeEff)(Data_FoldableWithIndex.foldableWithIndexArray)(res_.value0.value0.value0.error.value0)(function (i) {
                                  return function (v4) {
                                      return function __do() {
                                          var v5 = Control_Monad_Eff_JQuery.create("<h1>")();
                                          Control_Monad_Eff_JQuery.addClass("error-banner")(v5)();
                                          Control_Monad_Eff_JQuery.appendText("Error " + (Data_Show.show(Data_Show.showInt)(i + 1 | 0) + (" of " + Data_Show.show(Data_Show.showInt)(Data_Array.length(res_.value0.value0.value0.error.value0)))))(v5)();
                                          var v6 = Control_Monad_Eff_JQuery.create("<pre>")();
                                          var v7 = Control_Monad_Eff_JQuery.create("<code>")();
                                          Control_Monad_Eff_JQuery.append(v7)(v6)();
                                          Control_Monad_Eff_JQuery.appendText(v4.message)(v7)();
                                          Control_Monad_Eff_JQuery.append(v5)(v1)();
                                          Control_Monad_Eff_JQuery.append(v6)(v1)();
                                          return Control_Monad_Eff_Uncurried.runEffFn4($foreign.addErrorMarker)(v4.position.startLine)(v4.position.startColumn)(v4.position.endLine)(v4.position.endColumn)();
                                      };
                                  };
                              })();
                          };
                          ...
                          throw new Error("Failed pattern match at Main line 79, column 13 - line 100, column 53: " + [ res_.value0.value0.value0.error.constructor.name ]);
                      };
                      if (res_.value0 instanceof Data_Either.Left) {
                          displayPlainText("Unable to parse the response from the server")();
                          return Data_Foldable.traverse_(Control_Monad_Eff.applicativeEff)(Data_List_Types.foldableNonEmptyList)(function ($165) {
                              return Control_Monad_Eff_Console.error(Data_Foreign.renderForeignError($165));
                          })(res_.value0.value0)();
                      };
                      throw new Error("Failed pattern match at Main line 72, column 9 - line 103, column 58: " + [ res_.value0.constructor.name ]);
                  };
              };
              throw new Error("Failed pattern match at Main line 67, column 5 - line 103, column 58: " + [ res_.constructor.name ]);
          })();
      };
  };
  var changeViewMode = function (jq) {
      return function __do() {
          ...
          var v4 = Control_Bind.bind(Control_Monad_Eff.bindEff)(Control_Monad_Eff_JQuery_Extras.filter(jq)(":checked"))(Control_Monad_Eff_JQuery_Extras.getValueMaybe)();
          if (v4 instanceof Data_Maybe.Just && v4.value0 === "code") {
          ...
          if (v4 instanceof Data_Maybe.Just && v4.value0 === "output") {
  ...
  var cacheCurrentCode = function __do() {
      ...
      throw new Error("Failed pattern match at Main line 292, column 3 - line 299, column 1: " + [ v.constructor.name ]);
  };
          ...
          var onComplete = function (dictPartial) {
              return function (v1) {
                  ...
                  return __unused(dictPartial)((function () {
                      ...
                      throw new Error("Failed pattern match at Main line 223, column 7 - line 228, column 31: " + [ v1.constructor.name ]);
                  })());
              };
          };
          var getAll = Control_Parallel.parTraverse(Control_Parallel_Class.monadParExceptT(Control_Parallel_Class.monadParParCont(Control_Monad_Eff_Class.monadEffEff)))(Data_Traversable.traversableArray)(Try_API.get)([ "js/console.js", "js/react.min.js", "js/react-dom.min.js", v.endpoint + "/bundle" ]);
  ...
  var getBackend = function (v) {
      if (v instanceof Try_Types.Core) {
          return {
              backend: "core",
      ...
      if (v instanceof Try_Types.Thermite) {
          return {
              backend: "thermite",
      ...
      if (v instanceof Try_Types.Slides) {
          return {
              backend: "slides",
      ...
      if (v instanceof Try_Types.Mathbox) {
          return {
              backend: "mathbox",
      ...
      if (v instanceof Try_Types.Behaviors) {
          return {
              backend: "behaviors",
      ...
      if (v instanceof Try_Types.Flare) {
          return {
              backend: "flare",
      ...
      throw new Error("Failed pattern match at Main line 445, column 1 - line 445, column 39: " + [ v.constructor.name ]);
  };
  ...
  var setupEditor = function (bc) {
      return function __do() {
          ...
          setupBackendMenu(bc)();
          (function __do() {
              var $166 = Control_Bind.bind(Control_Monad_Eff.bindEff)(Control_Monad_Eff_JQuery.select("#code_textarea"))(Control_Monad_Eff_JQuery_Extras.getValueMaybe)();
              return Control_Monad_Eff_Uncurried.runEffFn1($foreign.setEditorContent)(Data_Foldable.fold(Data_Foldable.foldableMaybe)(Data_Monoid.monoidString)($166))();
          })();
  ...
  var withSession = function (sessionId) {
      return function (k) {
          return function __do() {
              ...
              if (v instanceof Data_Maybe.Nothing) {
                  var v1 = Data_Functor.map(Control_Monad_Eff.functorEff)(function ($167) {
                      return getBackendFromString(Data_Maybe.fromMaybe("core")($167));
              ...
              throw new Error("Failed pattern match at Main line 281, column 3 - line 286, column 29: " + [ v.constructor.name ]);
          };
      };
  };
