...
(function(exports) {
  ...
  var resolver = function (output) {
      var go = $foreign.resolver_(output);
      return function (src) {
          return function (k) {
              return go(src)(k);
          };
      ...
      var onComplete = function (dictPartial) {
          return function (v) {
              ...
              return $__unused(dictPartial)((function () {
                  ...
                  throw new Error("Failed pattern match at Try.API line 165, column 7 - line 167, column 23: " + [ v.constructor.name ]);
              })());
          };
      };
  ...
  var getBackendConfig = function (v) {
      ...
      throw new Error("Failed pattern match at Try.API line 249, column 1 - line 249, column 45: " + [ v.constructor.name ]);
  };
  var backendFromString = function (dictPartial) {
      return function (v) {
          ...
          return $__unused(dictPartial)((function () {
              ...
              throw new Error("Failed pattern match at Try.API line 229, column 1 - line 229, column 50: " + [ v.constructor.name ]);
          })());
      };
  };
...
(function(exports) {
      ...
      return function (backend) {
          return function (k) {
              return Control_Monad_Cont_Trans.runContT(Control_Monad_Except_Trans.runExceptT(Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Cont_Trans.monadContT(Effect.monadEffect)))(Try_Gist.getGistById(id_))(function (gi) {
                  ...
                  throw new Error("Failed pattern match at Main line 253, column 5 - line 257, column 40: " + [ v.constructor.name ]);
              });
          };
      };
  };
          ...
          return function __do() {
              ...
              if (v instanceof Data_Maybe.Nothing) {
                  var v1 = Data_Functor.map(Effect.functorEffect)(function ($132) {
                      return Try_API.getBackendConfigFromString(Data_Maybe.fromMaybe("core")($132));
              ...
              throw new Error("Failed pattern match at Main line 265, column 3 - line 271, column 29: " + [ v.constructor.name ]);
          };
      };
  };
      ...
      return function __do() {
          ...
          return Control_Applicative.when(Effect.applicativeEffect)(v1)(function __do() {
              ...
              return Control_Monad_Cont_Trans.runContT(Control_Monad_Except_Trans.runExceptT(Try_Gist.uploadGist(v2)))(function (v3) {
                  ...
                  throw new Error("Failed pattern match at Main line 294, column 7 - line 300, column 71: " + [ v3.constructor.name ]);
              })();
          })();
      };
  };
  ...
  var execute = function (js) {
      return function (sources) {
          return function (v) {
              var json = Foreign_Generic.encodeJSON(Foreign_Class.objectEncode(Foreign_Class.stringEncode))(Foreign_Object.insert("<file>")(Data_Newtype.unwrap(Try_Types.newtypeJS)(js))(sources));
              var scripts = Data_String_Common.joinWith("\x0a")([ "var load = PSLoader(" + (json + ");"), "load(\"<file>\").main();" ]);
              var html = Data_String_Common.joinWith("\x0a")([ "<!DOCTYPE html>", "<html>", "  <head>", "    <meta content=\"text/html;charset=utf-8\" http-equiv=\"Content-Type\">", "    <meta content=\"utf-8\" http-equiv=\"encoding\">", "    <meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\">", "    <title>Try PureScript!</title>", "    <script src=\"js/ps-loader.js\"></script>", "    <link rel=\"stylesheet\" href=\"css/style.css\">", v.extra_styling, "  </head>", "  <body>", v.extra_body, "  </body>", "</html>" ]);
              return function __do() {
              ...
              if (res_ instanceof Data_Either.Right) {
                  return function __do() {
                      ...
                      if (res_.value0 instanceof Data_Either.Right && res_.value0.value0 instanceof Try_API.CompileSuccess) {
                          ...
                          return Control_Monad_Cont_Trans.runContT(v.resolve(res_.value0.value0.value0.js))(function (sources) {
                              return function __do() {
                                  hideLoadingMessage();
                                  ...
                                  return execute(res_.value0.value0.value0.js)(sources)(v)();
                              };
                          })();
                      };
                      if (res_.value0 instanceof Data_Either.Right && res_.value0.value0 instanceof Try_API.CompileFailed) {
                          ...
                          throw new Error("Failed pattern match at Main line 160, column 13 - line 181, column 53: " + [ res_.value0.value0.value0.error.constructor.name ]);
                      };
                      ...
                      throw new Error("Failed pattern match at Main line 140, column 9 - line 185, column 58: " + [ res_.value0.constructor.name ]);
                  };
              };
              throw new Error("Failed pattern match at Main line 135, column 5 - line 185, column 58: " + [ res_.constructor.name ]);
          })();
      };
  };
  ...
  var loadOptions = function (bc) {
      return function __do() {
          ...
          throw new Error("Failed pattern match at Main line 329, column 3 - line 331, column 61: " + [ v3.constructor.name ]);
      };
  };
  ...
  var cacheCurrentCode = function (v) {
      return function __do() {
          ...
          throw new Error("Failed pattern match at Main line 277, column 3 - line 283, column 1: " + [ v1.constructor.name ]);
      };
  };
              ...
              return function (jq) {
                  return function __do() {
                      var v1 = Data_Functor.map(Effect.functorEffect)(function ($134) {
                          return Try_API.getBackendConfigFromString(Data_Maybe.fromMaybe("core")($134));
