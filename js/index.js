...
(function(exports) {
  ...
  var tryRestoreCachedCodeMaybe = function ($90) {
      return Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Nullable.toMaybe)(Control_Monad_Eff_Uncurried.runEffFn1($foreign.tryRestoreCachedCode)($90));
  };
  var tryLoadFileFromGistContT = function (gi) {
      return function (filename) {
          return function (k) {
              return Control_Monad_Eff_Uncurried.runEffFn4($foreign.tryLoadFileFromGist)(gi)(filename)(Control_Monad_Eff_Uncurried.mkEffFn1(function ($91) {
  ...
  var randomGuid = (function () {
      ...
      var s4 = Data_Functor.map(Control_Monad_Eff.functorEff)(function ($93) {
          return padLeft(Data_Int.toStringAs(Data_Int.hexadecimal)($93));
  ...
  var getValueMaybe = function ($94) {
      return Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Nullable.toMaybe)(Control_Monad_Eff_Uncurried.runEffFn1($foreign.getValue)($94));
  };
  var getQueryStringMaybe = function ($95) {
      return Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Nullable.toMaybe)(Control_Monad_Eff_Uncurried.runEffFn1($foreign.getQueryString)($95));
  };
  ...
  var setupSession = Control_Monad_Eff_Uncurried.mkEffFn1(function (k) {
      return function __do() {
          ...
          throw new Error("Failed pattern match at Main line 153, column 3 - line 157, column 1: " + [ v.constructor.name ]);
      };
  });
  ...
  var getGistByIdContT = function (id_) {
      return function (k) {
          return Control_Monad_Eff_Uncurried.runEffFn3($foreign.getGistById)(id_)(Control_Monad_Eff_Uncurried.mkEffFn1(function ($96) {
              return k(Data_Either.Right.create($96));
          }))(Control_Monad_Eff_Uncurried.mkEffFn1(function ($97) {
              return k(Data_Either.Left.create($97));
          }));
      };
  };
  ...
  var getContT = function (uri) {
      return function (k) {
          return Control_Monad_Eff_Uncurried.runEffFn3($foreign.get)(uri)(Control_Monad_Eff_Uncurried.mkEffFn1(function ($98) {
              return k(Data_Either.Right.create($98));
          }))(Control_Monad_Eff_Uncurried.mkEffFn1(function ($99) {
              return k(Data_Either.Left.create($99));
          }));
      };
  };
  ...
  var ordBackend = new Data_Ord.Ord(function () {
      ...
      return function (y) {
          ...
          throw new Error("Failed pattern match at Main line 305, column 8 - line 305, column 42: " + [ x.constructor.name, y.constructor.name ]);
      };
  });
  ...
  var getBackend = function (v) {
      ...
      throw new Error("Failed pattern match at Main line 307, column 1 - line 307, column 39: " + [ v.constructor.name ]);
  };
  var backendToString = function (v) {
      ...
      throw new Error("Failed pattern match at Main line 296, column 1 - line 296, column 37: " + [ v.constructor.name ]);
  };
  var backendFromString = function (dictPartial) {
      return function (v) {
          ...
          return __unused(dictPartial)((function () {
              ...
              throw new Error("Failed pattern match at Main line 288, column 1 - line 288, column 50: " + [ v.constructor.name ]);
          })());
      };
  };
  ...
  var loadOptions = Control_Monad_Eff_Uncurried.mkEffFn1(function (v) {
      return function __do() {
          ...
          (function () {
              ...
              throw new Error("Failed pattern match at Main line 251, column 3 - line 253, column 47: " + [ v4.constructor.name ]);
          })()();
          return Control_Bind.bind(Control_Monad_Eff.bindEff)(Control_Monad_Eff_JQuery.select("input[name=backend_inputs]"))(Control_Monad_Eff_JQuery.on("change")(function (e) {
              return function (jq) {
                  return function __do() {
                      ...
                      var v6 = $foreign.confirm("Replace your current code with the " + (v5.backend + " backend sample code?"))();
                      (function () {
                          if (v6) {
  ...
  var loadFromGist = Control_Monad_Eff_Uncurried.mkEffFn2(function (id_) {
      return function (backend) {
          return Control_Monad_Cont_Trans.runContT(Control_Monad_Except_Trans.runExceptT(Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Cont_Trans.monadContT(Control_Monad_Eff.monadEff)))(getGistByIdContT(id_))(function (gi) {
              ...
              throw new Error("Failed pattern match at Main line 95, column 5 - line 101, column 56: " + [ v.constructor.name ]);
          });
      };
  });
  var withSession = Control_Monad_Eff_Uncurried.mkEffFn1(function (sessionId) {
      return function __do() {
          ...
          if (v instanceof Data_Maybe.Nothing) {
              var v1 = Data_Functor.map(Control_Monad_Eff.functorEff)(function ($100) {
                  return getBackendFromString(Data_Maybe.fromMaybe("core")($100));
