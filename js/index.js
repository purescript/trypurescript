...
(function(exports) {
  ...
  var uploadGistContT = function (content) {
      return function (k) {
          return Control_Monad_Eff_Uncurried.runEffFn3($foreign.uploadGist)(content)(Control_Monad_Eff_Uncurried.mkEffFn1(function ($128) {
              return k(Data_Either.Right.create($128));
          }))(Control_Monad_Eff_Uncurried.mkEffFn1(function ($129) {
              return k(Data_Either.Left.create($129));
          }));
      };
  };
  ...
  var tryLoadFileFromGistContT = function (gi) {
      return function (filename) {
          return function (k) {
              return Control_Monad_Eff_Uncurried.runEffFn4($foreign.tryLoadFileFromGist)(gi)(filename)(Control_Monad_Eff_Uncurried.mkEffFn1(function ($130) {
  ...
  var randomGuid = (function () {
      ...
      var s4 = Data_Functor.map(Control_Monad_Eff.functorEff)(function ($132) {
          return padLeft(Data_Int.toStringAs(Data_Int.hexadecimal)($132));
  ...
  var getValueMaybe = function ($133) {
      return Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Nullable.toMaybe)(Control_Monad_Eff_Uncurried.runEffFn1($foreign.getValue)($133));
  };
  var getQueryParams = (function () {
      ...
      var breakQueryString = function ($134) {
          return (function ($135) {
              return Data_StrMap.fromFoldable(Data_Foldable.foldableArray)(Data_Array.catMaybes(Data_Functor.map(Data_Functor.functorArray)(function ($136) {
                  return parseQueryTerm(Data_String.split(Data_Newtype.wrap(Data_String.newtypePattern)("="))($136));
              })($135)));
          })(Data_String.split(Data_Newtype.wrap(Data_String.newtypePattern)("&"))(Data_String.drop(1)($134)));
      };
  ...
  var getGistByIdContT = function (id_) {
      return function (k) {
          return Control_Monad_Eff_Uncurried.runEffFn3($foreign.getGistById)(id_)(Control_Monad_Eff_Uncurried.mkEffFn1(function ($137) {
              return k(Data_Either.Right.create($137));
          }))(Control_Monad_Eff_Uncurried.mkEffFn1(function ($138) {
              return k(Data_Either.Left.create($138));
          }));
      };
  };
  ...
  var getContT = function (uri) {
      return function (k) {
          return Control_Monad_Eff_Uncurried.runEffFn3($foreign.get)(uri)(Control_Monad_Eff_Uncurried.mkEffFn1(function ($139) {
              return k(Data_Either.Right.create($139));
          }))(Control_Monad_Eff_Uncurried.mkEffFn1(function ($140) {
              return k(Data_Either.Left.create($140));
          }));
      };
  };
  ...
  var setupEditorWith = Control_Monad_Eff_Uncurried.mkEffFn1(function (bc) {
      return function __do() {
          (function __do() {
              var $141 = Control_Bind.bind(Control_Monad_Eff.bindEff)(Control_Monad_Eff_JQuery.select("#code_textarea"))(getValueMaybe)();
              return Control_Monad_Eff_Uncurried.runEffFn1($foreign.setEditorContent)(Data_Foldable.fold(Data_Foldable.foldableMaybe)(Data_Monoid.monoidString)($141))();
          })();
  ...
  var withSession = Control_Monad_Eff_Uncurried.mkEffFn1(function (sessionId) {
      return function __do() {
          ...
          if (v instanceof Data_Maybe.Nothing) {
              var v1 = Data_Functor.map(Control_Monad_Eff.functorEff)(function ($142) {
                  return getBackendFromString(Data_Maybe.fromMaybe("core")($142));
