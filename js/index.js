...
(function(exports) {
  ...
  var parseDeps = function (current) {
      ...
      return function ($44) {
          return Data_Array.mapMaybe(go)(Data_String_Common.split("\x0a")(Data_Newtype.unwrap(Try_Types.newtypeJS)($44)));
      };
  };
  var makeLoader = function (rootPath) {
      ...
      var load = function (v) {
          return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Cont_Trans.monadContT(Effect.monadEffect)))(Effect_Class.liftEffect(Control_Monad_Except_Trans.monadEffectExceptT(Control_Monad_Cont_Trans.monadEffectContT(Effect_Class.monadEffectEffect)))(getModule(v.name)))(function (v1) {
              ...
              if (v1 instanceof Data_Maybe.Nothing) {
                  return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Cont_Trans.monadContT(Effect.monadEffect)))((function () {
                      ...
                      if (v.path instanceof Data_Maybe.Nothing) {
                          var v2 = Foreign_Object.lookup(v.name)(Try_Shim.shims);
                          if (v2 instanceof Data_Maybe.Just) {
                              return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Cont_Trans.monadContT(Effect.monadEffect)))(Try_API.get(v2.value0.url))(function (v3) {
                                  var src = Try_Types.JS(v3 + ("\x0a//@ sourceURL=" + v2.value0.url));
                                  var deps = Data_Functor.map(Data_Functor.functorArray)(function (v4) {
                                      return {
                                          name: v4,
                                          path: Data_Maybe.Nothing.value
                                      };
                          ...
                          throw new Error("Failed pattern match at Try.Loader line 107, column 24 - line 115, column 64: " + [ v2.constructor.name ]);
                      };
                      throw new Error("Failed pattern match at Try.Loader line 102, column 11 - line 115, column 64: " + [ v.path.constructor.name ]);
                  })())(function (v2) {
              ...
              throw new Error("Failed pattern match at Try.Loader line 98, column 5 - line 117, column 17: " + [ v1.constructor.name ]);
          });
      };
      var go = function (ms) {
          return function (v) {
              if (v.length === 0) {
                  return Control_Applicative.pure(Control_Monad_Except_Trans.applicativeExceptT(Control_Monad_Cont_Trans.monadContT(Effect.monadEffect)))(ms);
              };
              return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Cont_Trans.monadContT(Effect.monadEffect)))(Control_Parallel.parTraverse(Control_Parallel_Class.monadParExceptT(Control_Parallel_Class.monadParParCont(Effect_Class.monadEffectEffect)))(Data_Traversable.traversableArray)(load)(v))(function (v1) {
                  ...
                  return go(ms$prime)(Data_Array.nubBy(Data_Ord.comparing(Data_Ord.ordString)(function (v2) {
                      return v2.name;
      ...
      return function ($45) {
          return go(Foreign_Object.empty)(parseDeps("<file>")($45));
      };
  };
...
(function(exports) {
  ...
  var loadFromGist = function (id_) {
      return function (k) {
          return Control_Monad_Cont_Trans.runContT(Control_Monad_Except_Trans.runExceptT(Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Cont_Trans.monadContT(Effect.monadEffect)))(Try_Gist.getGistById(id_))(function (gi) {
              ...
              throw new Error("Failed pattern match at Main line 228, column 5 - line 232, column 31: " + [ v.constructor.name ]);
          });
      };
  };
  var withSession = function (sessionId) {
      return function (k) {
          return function __do() {
              ...
              throw new Error("Failed pattern match at Main line 240, column 3 - line 244, column 26: " + [ v.constructor.name ]);
          };
      };
  };
  ...
  var publishNewGist = function __do() {
      ...
      return Control_Applicative.when(Effect.applicativeEffect)(v)(function __do() {
          ...
          return Control_Monad_Cont_Trans.runContT(Control_Monad_Except_Trans.runExceptT(Try_Gist.uploadGist(v1)))(function (v2) {
              ...
              throw new Error("Failed pattern match at Main line 267, column 7 - line 272, column 59: " + [ v2.constructor.name ]);
          })();
      })();
  };
  var execute = function (js) {
      return function (modules) {
          var eventData = Foreign_Object.insert("<file>")(js)(modules);
          return function __do() {
          ...
          if (res_ instanceof Data_Either.Right) {
              return function __do() {
                  ...
                  if (res_.value0 instanceof Data_Either.Right && res_.value0.value0 instanceof Try_API.CompileSuccess) {
                      ...
                      return Control_Monad_Cont_Trans.runContT(Control_Monad_Except_Trans.runExceptT(Try_Loader.runLoader(loader)(res_.value0.value0.value0.js)))(function (sources) {
                          return function __do() {
                              ...
                              return Data_Foldable.for_(Effect.applicativeEffect)(Data_Either.foldableEither)(sources)(execute(res_.value0.value0.value0.js))();
                          };
                      })();
                  };
                  if (res_.value0 instanceof Data_Either.Right && res_.value0.value0 instanceof Try_API.CompileFailed) {
                      ...
                      throw new Error("Failed pattern match at Main line 161, column 13 - line 182, column 53: " + [ res_.value0.value0.value0.error.constructor.name ]);
                  };
                  if (res_.value0 instanceof Data_Either.Left) {
                      hideLoadingMessage();
                      displayPlainText("Unable to parse the response from the server")();
                      return Data_Foldable.traverse_(Effect.applicativeEffect)(Data_List_Types.foldableNonEmptyList)(function ($110) {
                          return Effect_Console.error(Foreign.renderForeignError($110));
                      })(res_.value0.value0)();
                  };
                  throw new Error("Failed pattern match at Main line 141, column 9 - line 186, column 58: " + [ res_.value0.constructor.name ]);
              };
          };
          throw new Error("Failed pattern match at Main line 136, column 5 - line 186, column 58: " + [ res_.constructor.name ]);
      })();
  };
  ...
  var loadOptions = function __do() {
      ...
      throw new Error("Failed pattern match at Main line 301, column 3 - line 303, column 61: " + [ v3.constructor.name ]);
  };
  var cacheCurrentCode = function __do() {
      ...
      throw new Error("Failed pattern match at Main line 250, column 3 - line 256, column 1: " + [ v.constructor.name ]);
  };
