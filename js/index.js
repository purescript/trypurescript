...
(function(exports) {
  // Generated by purs version 0.12.0
  "use strict";
  var mainGist = "b57a766d417e109785540d584266fc33";
  var loaderUrl = "staging/core/.psci_modules/node_modules";
  var compileUrl = "http://localhost:8081";
  exports["loaderUrl"] = loaderUrl;
  exports["compileUrl"] = compileUrl;
  exports["mainGist"] = mainGist;
})(PS["Try.Config"] = PS["Try.Config"] || {});
(function(exports) {
    "use strict";
...
(function(exports) {
  ...
  var ffiDep = function (name) {
      ...
      throw new Error("Failed pattern match at Try.Loader line 139, column 3 - line 141, column 81: " + [ v.constructor.name ]);
  };
  var dirname = function (path) {
      return Data_Maybe.fromMaybe("")(Control_Bind.bind(Data_Maybe.bindMaybe)(Data_String_CodePoints.lastIndexOf("/")(path))(function (v) {
          return Control_Applicative.pure(Data_Maybe.applicativeMaybe)(Data_String_CodePoints.take(v)(path));
      }));
  };
  var resolvePath = function (a) {
      return function (b) {
          if (Data_String_CodePoints.take(2)(b) === "./") {
              return Data_Maybe.Just.create(dirname(a) + Data_String_CodePoints.drop(1)(b));
          };
          if (Data_String_CodePoints.take(3)(b) === "../") {
              return Data_Maybe.Just.create(dirname(dirname(a)) + Data_String_CodePoints.drop(2)(b));
          };
          if (Data_Boolean.otherwise) {
              return Data_Maybe.Nothing.value;
          };
          throw new Error("Failed pattern match at Try.Loader line 55, column 1 - line 55, column 48: " + [ a.constructor.name, b.constructor.name ]);
      };
  };
          ...
          return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_String_Regex.match(requireRegex)(line))(function (v) {
              return Control_Bind.bind(Data_Maybe.bindMaybe)(Control_Bind.join(Data_Maybe.bindMaybe)(Data_Array_NonEmpty.index(v)(1)))(function (v1) {
                  return Control_Applicative.pure(Data_Maybe.applicativeMaybe)((function () {
                      var v2 = resolvePath(current)(v1);
                      if (v2 instanceof Data_Maybe.Just) {
                          return {
                              name: v2.value0,
                              path: Data_String_CodeUnits.stripPrefix("/")(v2.value0)
                          };
                      };
                      return {
                          name: v1,
          ...
          return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Cont_Trans.monadContT(Effect.monadEffect)))(Effect_Class.liftEffect(Control_Monad_Except_Trans.monadEffectExceptT(Control_Monad_Cont_Trans.monadEffectContT(Effect_Class.monadEffectEffect)))(getModule(v.name)))(function (v1) {
              ...
              if (v1 instanceof Data_Maybe.Nothing) {
                  return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Cont_Trans.monadContT(Effect.monadEffect)))((function () {
                      ...
                      throw new Error("Failed pattern match at Try.Loader line 107, column 11 - line 112, column 62: " + [ v.path.constructor.name ]);
                  })())(function (v2) {
              ...
              throw new Error("Failed pattern match at Try.Loader line 103, column 5 - line 114, column 17: " + [ v1.constructor.name ]);
          });
      };
      var go = function (ms) {
          return function (ffi) {
...
(function(exports) {
  ...
  var loader = Try_Loader.makeLoader(Try_Config.loaderUrl);
  var loadFromGist = function (id_) {
      return function (k) {
          return Control_Monad_Cont_Trans.runContT(Control_Monad_Except_Trans.runExceptT(Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Cont_Trans.monadContT(Effect.monadEffect)))(Try_Gist.getGistById(id_))(function (gi) {
              ...
              throw new Error("Failed pattern match at Main line 233, column 5 - line 237, column 31: " + [ v.constructor.name ]);
          });
      };
  };
  var withSession = function (sessionId) {
      return function (k) {
          return function __do() {
              ...
              if (v instanceof Data_Maybe.Nothing) {
                  var v1 = Data_Functor.map(Effect.functorEffect)(Data_Maybe.fromMaybe(Try_Config.mainGist))(Try_QueryString.getQueryStringMaybe("gist"))();
                  return loadFromGist(v1)(k)();
              };
              throw new Error("Failed pattern match at Main line 245, column 3 - line 249, column 26: " + [ v.constructor.name ]);
          };
      };
  };
  ...
  var publishNewGist = function __do() {
      var v = Control_Bind.bind(Effect.bindEffect)(Web_HTML.window)(Web_HTML_Window.confirm(Data_Foldable.intercalate(Data_Foldable.foldableArray)(Data_Monoid.monoidString)("\x0a")([ "Do you really want to publish this code as an anonymous Gist?", "", "Note: this code will be available to anyone with a link to the Gist." ])))();
      return Control_Applicative.when(Effect.applicativeEffect)(v)(function __do() {
          var v1 = getTextAreaContent();
          return Control_Monad_Cont_Trans.runContT(Control_Monad_Except_Trans.runExceptT(Try_Gist.uploadGist(v1)))(function (v2) {
              if (v2 instanceof Data_Either.Left) {
                  return function __do() {
                      Control_Bind.bind(Effect.bindEffect)(Web_HTML.window)(Web_HTML_Window.alert("Failed to create gist"))();
                      return Effect_Console.error("Failed to create gist: " + v2.value0)();
                  };
              };
              if (v2 instanceof Data_Either.Right) {
                  return Try_QueryString.setQueryStrings(Foreign_Object.singleton("gist")(v2.value0));
              };
              throw new Error("Failed pattern match at Main line 272, column 7 - line 277, column 59: " + [ v2.constructor.name ]);
          })();
      })();
  };
      ...
      return function (modules) {
          return function (ffiDeps) {
              ...
              return function __do() {
                  ...
                  return $foreign.setupIFrame(v, eventData);
              };
          };
      };
  };
  ...
  var compile = function __do() {
      var v = getTextAreaContent();
      displayLoadingMessage();
      clearAnnotations();
      return Control_Monad_Cont_Trans.runContT(Control_Monad_Except_Trans.runExceptT(Try_API.compile(Try_Config.compileUrl)(v)))(function (res_) {
          ...
          if (res_ instanceof Data_Either.Right) {
              return function __do() {
                  ...
                  if (res_.value0 instanceof Data_Either.Right && res_.value0.value0 instanceof Try_API.CompileSuccess) {
                      var v1 = isShowJsChecked();
                      if (v1) {
                          hideLoadingMessage();
                          return displayPlainText(res_.value0.value0.value0.js)();
                      };
                      return Control_Monad_Cont_Trans.runContT(Control_Monad_Except_Trans.runExceptT(Try_Loader.runLoader(loader)(res_.value0.value0.value0.js)))(function (sources) {
                          return function __do() {
                              hideLoadingMessage();
                              ...
                              return Data_Foldable.for_(Effect.applicativeEffect)(Data_Either.foldableEither)(sources)(function (v2) {
                                  return execute(res_.value0.value0.value0.js)(v2.modules)(v2.ffiDeps);
                              })();
                          };
                      })();
                  };
                  if (res_.value0 instanceof Data_Either.Right && res_.value0.value0 instanceof Try_API.CompileFailed) {
                      ...
                      if (res_.value0.value0.value0.error instanceof Try_API.CompilerErrors) {
                          ...
                          var toAnnotation = function (v1) {
                              return Data_Functor.mapFlipped(Data_Maybe.functorMaybe)(v1.position)(function (v2) {
                                  return {
                                      row: v2.startLine - 1 | 0,
                                      column: v2.startColumn - 1 | 0,
                                      type: "error",
                                      text: v1.message
                                  };
                              });
                          ...
                          return Data_Foldable.for_(Effect.applicativeEffect)(Data_Foldable.foldableArray)(res_.value0.value0.value0.error.value0)(function (v1) {
                              return Data_Foldable.for_(Effect.applicativeEffect)(Data_Foldable.foldableMaybe)(v1.position)(function (v2) {
                                  return function () {
                                      return $foreign.addMarker("error", v2.startLine, v2.startColumn, v2.endLine, v2.endColumn);
                                  };
                              });
                          })();
                      };
                      ...
                      throw new Error("Failed pattern match at Main line 162, column 13 - line 183, column 53: " + [ res_.value0.value0.value0.error.constructor.name ]);
                  };
                  if (res_.value0 instanceof Data_Either.Left) {
                      hideLoadingMessage();
                      displayPlainText("Unable to parse the response from the server")();
                      return Data_Foldable.traverse_(Effect.applicativeEffect)(Data_List_Types.foldableNonEmptyList)(function ($114) {
                          return Effect_Console.error(Foreign.renderForeignError($114));
                      })(res_.value0.value0)();
                  };
                  throw new Error("Failed pattern match at Main line 141, column 9 - line 187, column 58: " + [ res_.value0.constructor.name ]);
              };
          };
          throw new Error("Failed pattern match at Main line 136, column 5 - line 187, column 58: " + [ res_.constructor.name ]);
      })();
  };
  ...
  var loadOptions = function __do() {
      ...
      throw new Error("Failed pattern match at Main line 306, column 3 - line 308, column 61: " + [ v3.constructor.name ]);
  };
  var cacheCurrentCode = function __do() {
      var v = Try_QueryString.getQueryStringMaybe("session")();
      if (v instanceof Data_Maybe.Just) {
          var v1 = getTextAreaContent();
          return Try_Session.storeSession(v.value0)({
              code: v1
          })();
      };
      if (v instanceof Data_Maybe.Nothing) {
      ...
      throw new Error("Failed pattern match at Main line 255, column 3 - line 261, column 1: " + [ v.constructor.name ]);
  };
  var setupEditor = function (v) {
      return function __do() {
          ...
          $foreign.onEditorChanged(function (value) {
              ...
              return Control_Applicative.when(Effect.applicativeEffect)(v1)(compile)();
          }, 750);
