...
(function(exports) {
          ...
          var onComplete = function (dictPartial) {
              return function (v1) {
                  ...
                  return __unused(dictPartial)((function () {
                      ...
                      throw new Error("Failed pattern match at Main line 72, column 9 - line 77, column 33: " + [ v1.constructor.name ]);
                  })());
              };
          };
      ...
      return function (backend) {
          return Control_Monad_Cont_Trans.runContT(Control_Monad_Except_Trans.runExceptT(Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Cont_Trans.monadContT(Control_Monad_Eff.monadEff)))(getGistByIdContT(id_))(function (gi) {
              ...
              if (v instanceof Data_Either.Left) {
                  return function __do() {
                      Control_Monad_Eff_Console.log("Unable to load gist metadata or contents: " + v.value0)();
              ...
              throw new Error("Failed pattern match at Main line 90, column 5 - line 96, column 56: " + [ v.constructor.name ]);
          });
      };
  });
  var withSession = Control_Monad_Eff_Uncurried.mkEffFn1(function (sessionId) {
      return function __do() {
          ...
          throw new Error("Failed pattern match at Main line 104, column 3 - line 109, column 37: " + [ v.constructor.name ]);
      };
  });
