...
(function(exports) {
  ...
  var uploadGistContT = function (content) {
      return function (k) {
          return Control_Monad_Eff_Uncurried.runEffFn3($foreign.uploadGist)(content)(Control_Monad_Eff_Uncurried.mkEffFn1(function ($123) {
              return k(Data_Either.Right.create($123));
          }))(Control_Monad_Eff_Uncurried.mkEffFn1(function ($124) {
              return k(Data_Either.Left.create($124));
          }));
      };
  };
  ...
  var tryLoadFileFromGistContT = function (gi) {
      return function (filename) {
          return function (k) {
              return Control_Monad_Eff_Uncurried.runEffFn4($foreign.tryLoadFileFromGist)(gi)(filename)(Control_Monad_Eff_Uncurried.mkEffFn1(function ($125) {
                  return k(Data_Either.Right.create($125));
              }))(Control_Monad_Eff_Uncurried.mkEffFn1(function ($126) {
                  return k(Data_Either.Left.create($126));
              }));
          };
      };
  };
  var randomGuid = (function () {
      ...
      var s4 = Data_Functor.map(Control_Monad_Eff.functorEff)(function ($127) {
          return padLeft(Data_Int.toStringAs(Data_Int.hexadecimal)($127));
  ...
  var getValueMaybe = function ($128) {
      return Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Nullable.toMaybe)(Control_Monad_Eff_Uncurried.runEffFn1($foreign.getValue)($128));
  };
  var getQueryParams = (function () {
      ...
      var breakQueryString = function ($129) {
          return (function ($130) {
              return Data_StrMap.fromFoldable(Data_Foldable.foldableArray)(Data_Array.catMaybes(Data_Functor.map(Data_Functor.functorArray)(function ($131) {
                  return parseQueryTerm(Data_String.split(Data_Newtype.wrap(Data_String.newtypePattern)("="))($131));
              })($130)));
          })(Data_String.split(Data_Newtype.wrap(Data_String.newtypePattern)("&"))(Data_String.drop(1)($129)));
      };
  ...
  var setupSession = Control_Monad_Eff_Uncurried.mkEffFn1(function (k) {
      return function __do() {
          ...
          throw new Error("Failed pattern match at Main line 249, column 3 - line 253, column 1: " + [ v.constructor.name ]);
      };
  });
  ...
  var getGistByIdContT = function (id_) {
      return function (k) {
          return Control_Monad_Eff_Uncurried.runEffFn3($foreign.getGistById)(id_)(Control_Monad_Eff_Uncurried.mkEffFn1(function ($132) {
              return k(Data_Either.Right.create($132));
          }))(Control_Monad_Eff_Uncurried.mkEffFn1(function ($133) {
              return k(Data_Either.Left.create($133));
          }));
      };
  };
  ...
  var getContT = function (uri) {
      return function (k) {
          return Control_Monad_Eff_Uncurried.runEffFn3($foreign.get)(uri)(Control_Monad_Eff_Uncurried.mkEffFn1(function ($134) {
              return k(Data_Either.Right.create($134));
          }))(Control_Monad_Eff_Uncurried.mkEffFn1(function ($135) {
              return k(Data_Either.Left.create($135));
          }));
      };
  };
  ...
  var publishNewGist = function __do() {
      ...
      return Control_Applicative.when(Control_Monad_Eff.applicativeEff)(v)(function __do() {
          ...
          return Control_Monad_Cont_Trans.runContT(Control_Monad_Except_Trans.runExceptT(uploadGistContT(v1)))(function (v2) {
              ...
              throw new Error("Failed pattern match at Main line 236, column 7 - line 243, column 43: " + [ v2.constructor.name ]);
          })();
      })();
  };
  ...
  var ordBackend = new Data_Ord.Ord(function () {
      ...
      return function (y) {
          ...
          throw new Error("Failed pattern match at Main line 440, column 8 - line 440, column 42: " + [ x.constructor.name, y.constructor.name ]);
      };
  });
  ...
  var cacheCurrentCode = function __do() {
      ...
      throw new Error("Failed pattern match at Main line 177, column 3 - line 184, column 1: " + [ v.constructor.name ]);
  };
  ...
  var setupEditorWith = Control_Monad_Eff_Uncurried.mkEffFn1(function (bc) {
      return function __do() {
          (function __do() {
              var $136 = Control_Bind.bind(Control_Monad_Eff.bindEff)(Control_Monad_Eff_JQuery.select("#code_textarea"))(getValueMaybe)();
              return Control_Monad_Eff_Uncurried.runEffFn1($foreign.setEditorContent)(Data_Foldable.fold(Data_Foldable.foldableMaybe)(Data_Monoid.monoidString)($136))();
          })();
          Control_Monad_Eff_Uncurried.runEffFn2($foreign.onEditorChanged)(Control_Monad_Eff_Uncurried.mkEffFn1(function (value) {
              return function __do() {
                  ...
                  return Control_Applicative.when(Control_Monad_Eff.applicativeEff)(v)(Control_Monad_Eff_Uncurried.runEffFn1($foreign.compile)(bc))();
              };
          }))(750)();
          ...
          var onComplete = function (dictPartial) {
              return function (v1) {
                  ...
                  return __unused(dictPartial)((function () {
                      ...
                      throw new Error("Failed pattern match at Main line 119, column 9 - line 124, column 33: " + [ v1.constructor.name ]);
                  })());
              };
          };
  ...
  var getBackend = function (v) {
      ...
      throw new Error("Failed pattern match at Main line 442, column 1 - line 442, column 39: " + [ v.constructor.name ]);
  };
  var backendToString = function (v) {
      ...
      throw new Error("Failed pattern match at Main line 431, column 1 - line 431, column 37: " + [ v.constructor.name ]);
  };
  var backendFromString = function (dictPartial) {
      return function (v) {
          ...
          return __unused(dictPartial)((function () {
              ...
              throw new Error("Failed pattern match at Main line 423, column 1 - line 423, column 50: " + [ v.constructor.name ]);
          })());
      };
  };
  ...
  var loadOptions = Control_Monad_Eff_Uncurried.mkEffFn1(function (v) {
      return function __do() {
          ...
          (function () {
              ...
              throw new Error("Failed pattern match at Main line 386, column 3 - line 388, column 47: " + [ v4.constructor.name ]);
          })()();
  ...
  var loadFromGist = Control_Monad_Eff_Uncurried.mkEffFn2(function (id_) {
      return function (backend) {
          return Control_Monad_Cont_Trans.runContT(Control_Monad_Except_Trans.runExceptT(Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Cont_Trans.monadContT(Control_Monad_Eff.monadEff)))(getGistByIdContT(id_))(function (gi) {
              ...
              throw new Error("Failed pattern match at Main line 137, column 5 - line 143, column 38: " + [ v.constructor.name ]);
          });
      };
  });
  var withSession = Control_Monad_Eff_Uncurried.mkEffFn1(function (sessionId) {
      return function __do() {
          ...
          if (v instanceof Data_Maybe.Nothing) {
              var v1 = Data_Functor.map(Control_Monad_Eff.functorEff)(function ($137) {
                  return getBackendFromString(Data_Maybe.fromMaybe("core")($137));
          ...
          throw new Error("Failed pattern match at Main line 148, column 3 - line 153, column 37: " + [ v.constructor.name ]);
      };
  });
