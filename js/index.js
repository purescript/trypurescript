...
(function(exports) {
  ...
  var encodeJS = Foreign_Class.stringEncode;
  exports["JS"] = JS;
...
(function(exports) {
  ...
  var parseDeps = function (current) {
      ...
      return function ($34) {
          return Data_Array.mapMaybe(go)(Data_String_Common.split("\x0a")(Data_Newtype.unwrap(Try_Types.newtypeJS)($34)));
      };
  };
  var makeLoader = function (modFn) {
      return function (rootPath) {
          ...
          var load = function (v) {
              return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Cont_Trans.monadContT(Effect.monadEffect)))(Effect_Class.liftEffect(Control_Monad_Except_Trans.monadEffectExceptT(Control_Monad_Cont_Trans.monadEffectContT(Effect_Class.monadEffectEffect)))(getModule(v.name)))(function (v1) {
                  ...
                  if (v1 instanceof Data_Maybe.Nothing) {
                      return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Cont_Trans.monadContT(Effect.monadEffect)))(Data_Functor.map(Control_Monad_Except_Trans.functorExceptT(Control_Monad_Cont_Trans.functorContT(Effect.functorEffect)))(Try_Types.JS)(Try_API.get(rootPath + ("/" + v.path))))(function (v2) {
                          var mod = modFn({
                              name: v.name,
                              path: v.path,
                          ...
                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Cont_Trans.monadContT(Effect.monadEffect)))(Effect_Class.liftEffect(Control_Monad_Except_Trans.monadEffectExceptT(Control_Monad_Cont_Trans.monadEffectContT(Effect_Class.monadEffectEffect)))(putModule(v.name)(mod)))(function () {
                              return Control_Applicative.pure(Control_Monad_Except_Trans.applicativeExceptT(Control_Monad_Cont_Trans.monadContT(Effect.monadEffect)))(mod);
                          });
                      });
                  };
                  throw new Error("Failed pattern match at Try.Loader line 93, column 5 - line 99, column 17: " + [ v1.constructor.name ]);
              });
          };
          var go = function (deps) {
              return function (accum) {
                  return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Cont_Trans.monadContT(Effect.monadEffect)))(Control_Parallel.parTraverse(Control_Parallel_Class.monadParExceptT(Control_Parallel_Class.monadParParCont(Effect_Class.monadEffectEffect)))(Data_Traversable.traversableArray)(load)(deps))(function (v) {
                      var more = Data_Array.nubBy(Data_Ord.comparing(Data_Ord.ordString)(function (v1) {
                          return v1.name;
                      }))(Control_Bind.bindFlipped(Control_Bind.bindArray)(function (v1) {
                          return v1.deps;
                      })(v));
                      var accum$prime = Foreign_Object.union(accum)(Foreign_Object.fromFoldable(Data_Foldable.foldableArray)(Data_Functor.map(Data_Functor.functorArray)(function (v1) {
                          return new Data_Tuple.Tuple(v1.name, v1.src);
                      })(v)));
                      if (more.length === 0) {
                          return Control_Applicative.pure(Control_Monad_Except_Trans.applicativeExceptT(Control_Monad_Cont_Trans.monadContT(Effect.monadEffect)))(accum$prime);
                      };
                      return go(more)(accum$prime);
                  });
              };
          };
          return function (js) {
              var initDeps = parseDeps("<file>")(js);
              return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Cont_Trans.monadContT(Effect.monadEffect)))(go(initDeps)(Foreign_Object.empty))(function (v) {
                  return Control_Applicative.pure(Control_Monad_Except_Trans.applicativeExceptT(Control_Monad_Cont_Trans.monadContT(Effect.monadEffect)))(v);
              });
          };
      };
  };
  ...
  var getBackendConfig = function (v) {
      if (v instanceof Core) {
          return {
              ...
              extra_styling: "",
              extra_body: "",
              loader: Try_Loader.makeLoader(Control_Category.identity(Control_Category.categoryFn))("staging/core/.psci_modules/node_modules"),
...
(function(exports) {
      ...
      return function (backend) {
          return function (k) {
              return Control_Monad_Cont_Trans.runContT(Control_Monad_Except_Trans.runExceptT(Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Cont_Trans.monadContT(Effect.monadEffect)))(Try_Gist.getGistById(id_))(function (gi) {
                  ...
                  throw new Error("Failed pattern match at Main line 254, column 5 - line 258, column 40: " + [ v.constructor.name ]);
              });
          };
      };
  };
  var withSession = function (sessionId) {
      return function (k) {
          return function __do() {
              ...
              if (v instanceof Data_Maybe.Nothing) {
                  var v1 = Data_Functor.map(Effect.functorEffect)(function ($132) {
                      return Try_Backend.getBackendConfigFromString(Data_Maybe.fromMaybe("core")($132));
              ...
              throw new Error("Failed pattern match at Main line 266, column 3 - line 272, column 29: " + [ v.constructor.name ]);
          };
      };
  };
      ...
      return function __do() {
          ...
          return Control_Applicative.when(Effect.applicativeEffect)(v1)(function __do() {
              ...
              return Control_Monad_Cont_Trans.runContT(Control_Monad_Except_Trans.runExceptT(Try_Gist.uploadGist(v2)))(function (v3) {
                  ...
                  throw new Error("Failed pattern match at Main line 295, column 7 - line 301, column 71: " + [ v3.constructor.name ]);
              })();
          })();
      };
  };
  var execute = function (js) {
      return function (sources) {
          return function (v) {
              var json = Foreign_Generic.encodeJSON(Foreign_Class.objectEncode(Try_Types.encodeJS))(Foreign_Object.insert("<file>")(js)(sources));
              var scripts = Data_String_Common.joinWith("\x0a")([ "var load = PSRequireShim(" + (json + ");"), "load(\"<file>\").main();" ]);
              var html = Data_String_Common.joinWith("\x0a")([ "<!DOCTYPE html>", "<html>", "  <head>", "    <meta content=\"text/html;charset=utf-8\" http-equiv=\"Content-Type\">", "    <meta content=\"utf-8\" http-equiv=\"encoding\">", "    <meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\">", "    <title>Try PureScript!</title>", "    <script src=\"js/ps-require-shim.js\"></script>", "    <link rel=\"stylesheet\" href=\"css/style.css\">", v.extra_styling, "  </head>", "  <body>", v.extra_body, "  </body>", "</html>" ]);
              return function __do() {
              ...
              if (res_ instanceof Data_Either.Right) {
                  return function __do() {
                      ...
                      if (res_.value0 instanceof Data_Either.Right && res_.value0.value0 instanceof Try_API.CompileSuccess) {
                          ...
                          return Control_Monad_Cont_Trans.runContT(Control_Monad_Except_Trans.runExceptT(Try_Loader.runLoader(v.loader)(res_.value0.value0.value0.js)))(function (sources) {
                              return function __do() {
                                  ...
                                  return Data_Foldable.for_(Effect.applicativeEffect)(Data_Either.foldableEither)(sources)(function (sources$prime) {
                                      return execute(res_.value0.value0.value0.js)(sources$prime)(v);
                                  })();
                              };
                          })();
                      };
                      ...
                      if (res_.value0 instanceof Data_Either.Left) {
                          ...
                          return Data_Foldable.traverse_(Effect.applicativeEffect)(Data_List_Types.foldableNonEmptyList)(function ($133) {
                              return Effect_Console.error(Foreign.renderForeignError($133));
                          })(res_.value0.value0)();
                      };
                      throw new Error("Failed pattern match at Main line 140, column 9 - line 186, column 58: " + [ res_.value0.constructor.name ]);
                  };
              };
              throw new Error("Failed pattern match at Main line 135, column 5 - line 186, column 58: " + [ res_.constructor.name ]);
          })();
      };
  };
  ...
  var loadOptions = function (bc) {
      return function __do() {
          ...
          throw new Error("Failed pattern match at Main line 330, column 3 - line 332, column 61: " + [ v3.constructor.name ]);
      };
  };
  var cacheCurrentCode = function (v) {
      return function __do() {
          ...
          throw new Error("Failed pattern match at Main line 278, column 3 - line 284, column 1: " + [ v1.constructor.name ]);
      };
  };
  var setupBackendMenu = function (v) {
      return function __do() {
          ...
          return Control_Bind.bind(Effect.bindEffect)(JQuery.select("input[name=backend_inputs]"))(JQuery.on("change")(function (e) {
              return function (jq) {
                  return function __do() {
                      var v1 = Data_Functor.map(Effect.functorEffect)(function ($134) {
                          return Try_Backend.getBackendConfigFromString(Data_Maybe.fromMaybe("core")($134));
