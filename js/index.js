...
(function(exports) {
  ...
  var getBackendNameFromView = Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Maybe.fromMaybe("core"))(function __do() {
      ...
      return Control_Bind.bind(Control_Monad_Eff.bindEff)(Control_Monad_Eff_JQuery_Extras.filter(jq)(":checked"))(Control_Monad_Eff_JQuery_Extras.getValueMaybe)();
  });
  ...
  var compile = function (v) {
      return function __do() {
          (function __do() {
              ...
              Control_Monad_Eff_JQuery_Extras.empty(jq)();
          ...
          return Control_Monad_Cont_Trans.runContT(Control_Monad_Except_Trans.runExceptT(Try_API.compile(v)(v1)))(function (res_) {
                  ...
                  return function __do() {
                      ...
                      if (res_.value0 instanceof Data_Either.Right && res_.value0.value0 instanceof Try_API.CompileFailed) {
                          if (res_.value0.value0.value0.error instanceof Try_API.CompilerErrors) {
                              Control_Bind.bind(Control_Monad_Eff.bindEff)(Control_Monad_Eff_JQuery.select("#column2"))(Control_Monad_Eff_JQuery_Extras.empty)();
                                  ...
                                  return function (v2) {
                                      return function __do() {
                                          (function __do() {
                                              ...
                                              Control_Monad_Eff_JQuery.appendText("Error " + (Data_Show.show(Data_Show.showInt)(i + 1 | 0) + (" of " + Data_Show.show(Data_Show.showInt)(Data_Array.length(res_.value0.value0.value0.error.value0)))))(v3)();
                                              ...
                                              Control_Monad_Eff_JQuery.appendText(v2.message)(v5)();
                                              Control_Monad_Eff_JQuery.append(v3)(jq)();
                                              return Control_Monad_Eff_JQuery.append(v4)(jq)();
                                          })();
                          ...
                          throw new Error("Failed pattern match at Main line 74, column 13 - line 96, column 53: " + [ res_.value0.value0.value0.error.constructor.name ]);
                      };
              ...
              throw new Error("Failed pattern match at Main line 62, column 5 - line 99, column 58: " + [ res_.constructor.name ]);
          })();
      };
  };
  var changeViewMode = function (jq) {
      return function __do() {
          var v = Control_Bind.bind(Control_Monad_Eff.bindEff)(Control_Monad_Eff_JQuery_Extras.filter(jq)(":checked"))(Control_Monad_Eff_JQuery_Extras.getValueMaybe)();
