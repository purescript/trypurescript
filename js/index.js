...
(function(exports) {
  ...
  var withSession = function (sessionId) {
      return function (k) {
          return function __do() {
              ...
              throw new Error("Failed pattern match at Main line 320, column 3 - line 326, column 29: " + [ v.constructor.name ]);
          };
      };
  };
      ...
      return function __do() {
          ...
          return Control_Applicative.when(Control_Monad_Eff.applicativeEff)(v1)(function __do() {
              ...
              return Control_Monad_Cont_Trans.runContT(Control_Monad_Except_Trans.runExceptT(Try_Gist.uploadGist(v2)))(function (v3) {
                  ...
                  throw new Error("Failed pattern match at Main line 360, column 7 - line 366, column 71: " + [ v3.constructor.name ]);
              })();
          })();
      };
  };
  ...
  var loadOptions = function (bc) {
      return function __do() {
          ...
          throw new Error("Failed pattern match at Main line 403, column 3 - line 405, column 61: " + [ v3.constructor.name ]);
      };
  };
  var cacheCurrentCode = function (v) {
      return function __do() {
          ...
          throw new Error("Failed pattern match at Main line 335, column 3 - line 341, column 1: " + [ v1.constructor.name ]);
      };
  };
