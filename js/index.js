...
(function(exports) {
  ...
  var uploadGistContT = function (content) {
      return function (k) {
          return Control_Monad_Eff_Uncurried.runEffFn3($foreign.uploadGist)(content)(Control_Monad_Eff_Uncurried.mkEffFn1(function ($115) {
              return k(Data_Either.Right.create($115));
  ...
  var tryLoadFileFromGistContT = function (gi) {
      return function (filename) {
          return function (k) {
              return Control_Monad_Eff_Uncurried.runEffFn4($foreign.tryLoadFileFromGist)(gi)(filename)(Control_Monad_Eff_Uncurried.mkEffFn1(function ($117) {
                  return k(Data_Either.Right.create($117));
              }))(Control_Monad_Eff_Uncurried.mkEffFn1(function ($118) {
                  return k(Data_Either.Left.create($118));
              }));
          };
      };
  };
  var randomGuid = (function () {
      ...
      var s4 = Data_Functor.map(Control_Monad_Eff.functorEff)(function ($119) {
          return padLeft(Data_Int.toStringAs(Data_Int.hexadecimal)($119));
  ...
  var getValueMaybe = function ($120) {
      return Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Nullable.toMaybe)(Control_Monad_Eff_Uncurried.runEffFn1($foreign.getValue)($120));
  };
  var getQueryStringMaybe = function ($121) {
      return Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Nullable.toMaybe)(Control_Monad_Eff_Uncurried.runEffFn1($foreign.getQueryString)($121));
  };
  var setupSession = Control_Monad_Eff_Uncurried.mkEffFn1(function (k) {
      return function __do() {
          ...
          throw new Error("Failed pattern match at Main line 213, column 3 - line 217, column 1: " + [ v.constructor.name ]);
      };
  });
  ...
  var getGistByIdContT = function (id_) {
      return function (k) {
          return Control_Monad_Eff_Uncurried.runEffFn3($foreign.getGistById)(id_)(Control_Monad_Eff_Uncurried.mkEffFn1(function ($122) {
              return k(Data_Either.Right.create($122));
          }))(Control_Monad_Eff_Uncurried.mkEffFn1(function ($123) {
              return k(Data_Either.Left.create($123));
          }));
      };
  };
  var getContT = function (uri) {
      return function (k) {
          return Control_Monad_Eff_Uncurried.runEffFn3($foreign.get)(uri)(Control_Monad_Eff_Uncurried.mkEffFn1(function ($124) {
              return k(Data_Either.Right.create($124));
          }))(Control_Monad_Eff_Uncurried.mkEffFn1(function ($125) {
              return k(Data_Either.Left.create($125));
          }));
      };
  };
          ...
          return Control_Monad_Cont_Trans.runContT(Control_Monad_Except_Trans.runExceptT(uploadGistContT(v1)))(function (v2) {
              ...
              if (v2 instanceof Data_Either.Right) {
                  return function __do() {
                      ...
                      return Control_Monad_Eff_Uncurried.runEffFn2($foreign.setQueryString)("backend")(v3)();
                  };
              };
              throw new Error("Failed pattern match at Main line 200, column 7 - line 207, column 53: " + [ v2.constructor.name ]);
          })();
      })();
  };
  ...
  var ordBackend = new Data_Ord.Ord(function () {
      ...
      return function (y) {
          ...
          throw new Error("Failed pattern match at Main line 379, column 8 - line 379, column 42: " + [ x.constructor.name, y.constructor.name ]);
      };
  });
  ...
  var cacheCurrentCode = function __do() {
      ...
      throw new Error("Failed pattern match at Main line 135, column 3 - line 142, column 1: " + [ v.constructor.name ]);
  };
          ...
          var onComplete = function (dictPartial) {
              return function (v1) {
                  ...
                  return __unused(dictPartial)((function () {
                      ...
                      throw new Error("Failed pattern match at Main line 77, column 9 - line 82, column 33: " + [ v1.constructor.name ]);
                  })());
              };
          };
  ...
  var getBackend = function (v) {
      ...
      throw new Error("Failed pattern match at Main line 381, column 1 - line 381, column 39: " + [ v.constructor.name ]);
  };
  var backendToString = function (v) {
      ...
      throw new Error("Failed pattern match at Main line 370, column 1 - line 370, column 37: " + [ v.constructor.name ]);
  };
  var backendFromString = function (dictPartial) {
      return function (v) {
          ...
          return __unused(dictPartial)((function () {
              ...
              throw new Error("Failed pattern match at Main line 362, column 1 - line 362, column 50: " + [ v.constructor.name ]);
          })());
      };
  };
  ...
  var loadOptions = Control_Monad_Eff_Uncurried.mkEffFn1(function (v) {
      return function __do() {
          ...
          (function () {
              ...
              throw new Error("Failed pattern match at Main line 325, column 3 - line 327, column 47: " + [ v4.constructor.name ]);
          })()();
  ...
  var loadFromGist = Control_Monad_Eff_Uncurried.mkEffFn2(function (id_) {
      return function (backend) {
          return Control_Monad_Cont_Trans.runContT(Control_Monad_Except_Trans.runExceptT(Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Cont_Trans.monadContT(Control_Monad_Eff.monadEff)))(getGistByIdContT(id_))(function (gi) {
              ...
              throw new Error("Failed pattern match at Main line 95, column 5 - line 101, column 38: " + [ v.constructor.name ]);
          });
      };
  });
  var withSession = Control_Monad_Eff_Uncurried.mkEffFn1(function (sessionId) {
      return function __do() {
          ...
          if (v instanceof Data_Maybe.Nothing) {
              var v1 = Data_Functor.map(Control_Monad_Eff.functorEff)(function ($126) {
                  return getBackendFromString(Data_Maybe.fromMaybe("core")($126));
          ...
          throw new Error("Failed pattern match at Main line 106, column 3 - line 111, column 37: " + [ v.constructor.name ]);
      };
  });
