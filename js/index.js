  ...
  var withSession = function (sessionId) {
      return function (k) {
          return function __do() {
              ...
              if (v instanceof Data_Maybe.Nothing) {
                  var v1 = Data_Functor.map(Control_Monad_Eff.functorEff)(function ($158) {
                      return Try_API.getBackendConfigFromString(Data_Maybe.fromMaybe("core")($158));
                  ...
                  return function __do() {
                      ...
                      if (res_.value0 instanceof Data_Either.Left) {
                          ...
                          return Data_Foldable.traverse_(Control_Monad_Eff.applicativeEff)(Data_List_Types.foldableNonEmptyList)(function ($159) {
                              return Control_Monad_Eff_Console.error(Data_Foreign.renderForeignError($159));
                          })(res_.value0.value0)();
                      };
  ...
  var setupBackendMenu = function (v) {
      return function __do() {
          ...
          return Control_Bind.bind(Control_Monad_Eff.bindEff)(Control_Monad_Eff_JQuery.select("input[name=backend_inputs]"))(Control_Monad_Eff_JQuery.on("change")(function (e) {
              return function (jq) {
                  return function __do() {
                      var v1 = Data_Functor.map(Control_Monad_Eff.functorEff)(function ($160) {
                          return Try_API.getBackendConfigFromString(Data_Maybe.fromMaybe("core")($160));
