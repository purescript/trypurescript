...
(function(exports) {
      ...
      var onComplete = function (dictPartial) {
          return function (v) {
              ...
              return __unused(dictPartial)((function () {
                  ...
                  throw new Error("Failed pattern match at Try.API line 142, column 7 - line 144, column 23: " + [ v.constructor.name ]);
              })());
          };
      };
  ...
  var genericCompileError = new Data_Generic_Rep.Generic(function (x) {
      ...
      throw new Error("Failed pattern match at Try.API line 70, column 8 - line 70, column 62: " + [ x.constructor.name ]);
  }, function (x) {
  ...
  var getBackendConfig = function (v) {
      ...
      throw new Error("Failed pattern match at Try.API line 212, column 1 - line 212, column 45: " + [ v.constructor.name ]);
  };
  var backendFromString = function (dictPartial) {
      return function (v) {
          ...
          return __unused(dictPartial)((function () {
              ...
              throw new Error("Failed pattern match at Try.API line 193, column 1 - line 193, column 50: " + [ v.constructor.name ]);
          })());
      };
  };
...
(function(exports) {
      ...
      return function (backend) {
          return function (k) {
              return Control_Monad_Cont_Trans.runContT(Control_Monad_Except_Trans.runExceptT(Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Cont_Trans.monadContT(Control_Monad_Eff.monadEff)))(Try_Gist.getGistById(id_))(function (gi) {
                  ...
                  throw new Error("Failed pattern match at Main line 282, column 5 - line 286, column 40: " + [ v.constructor.name ]);
              });
          };
      };
  };
  var withSession = function (sessionId) {
      return function (k) {
          return function __do() {
              ...
              if (v instanceof Data_Maybe.Nothing) {
                  var v1 = Data_Functor.map(Control_Monad_Eff.functorEff)(function ($144) {
                      return Try_API.getBackendConfigFromString(Data_Maybe.fromMaybe("core")($144));
              ...
              throw new Error("Failed pattern match at Main line 306, column 3 - line 312, column 29: " + [ v.constructor.name ]);
          };
      };
  };
      ...
      return function __do() {
          ...
          return Control_Applicative.when(Control_Monad_Eff.applicativeEff)(v1)(function __do() {
              ...
              return Control_Monad_Cont_Trans.runContT(Control_Monad_Except_Trans.runExceptT(Try_Gist.uploadGist(v2)))(function (v3) {
                  ...
                  throw new Error("Failed pattern match at Main line 346, column 7 - line 352, column 71: " + [ v3.constructor.name ]);
              })();
          })();
      };
  };
              ...
              if (res_ instanceof Data_Either.Right) {
                  return function __do() {
                      ...
                      if (res_.value0 instanceof Data_Either.Right && res_.value0.value0 instanceof Try_API.CompileFailed) {
                          if (res_.value0.value0.value0.error instanceof Try_API.CompilerErrors) {
                              ...
                              return Data_Foldable.for_(Control_Monad_Eff.applicativeEff)(Data_Foldable.foldableArray)(res_.value0.value0.value0.error.value0)(function (v2) {
                                  return Data_Foldable.for_(Control_Monad_Eff.applicativeEff)(Data_Foldable.foldableMaybe)(Data_Newtype.unwrap(Data_Foreign_NullOrUndefined.newtypeNullOrUndefined)(v2.position))(function (v3) {
                                      return Control_Monad_Eff_Uncurried.runEffFn4($foreign.addErrorMarker)(v3.startLine)(v3.startColumn)(v3.endLine)(v3.endColumn);
                                  });
                              })();
                          };
                          ...
                          throw new Error("Failed pattern match at Main line 173, column 13 - line 184, column 53: " + [ res_.value0.value0.value0.error.constructor.name ]);
                      };
                      if (res_.value0 instanceof Data_Either.Left) {
                          displayPlainText("Unable to parse the response from the server")();
                          return Data_Foldable.traverse_(Control_Monad_Eff.applicativeEff)(Data_List_Types.foldableNonEmptyList)(function ($145) {
                              return Control_Monad_Eff_Console.error(Data_Foreign.renderForeignError($145));
                          })(res_.value0.value0)();
                      };
                      throw new Error("Failed pattern match at Main line 163, column 9 - line 187, column 58: " + [ res_.value0.constructor.name ]);
                  };
              };
              throw new Error("Failed pattern match at Main line 158, column 5 - line 187, column 58: " + [ res_.constructor.name ]);
          })();
      };
  };
  ...
  var loadOptions = function (bc) {
      return function __do() {
          ...
          throw new Error("Failed pattern match at Main line 389, column 3 - line 391, column 61: " + [ v3.constructor.name ]);
      };
  };
  var cacheCurrentCode = function (v) {
      return function __do() {
          ...
          throw new Error("Failed pattern match at Main line 321, column 3 - line 327, column 1: " + [ v1.constructor.name ]);
      };
  };
  var setupBackendMenu = function (v) {
      return function __do() {
          ...
          return Control_Bind.bind(Control_Monad_Eff.bindEff)(Control_Monad_Eff_JQuery.select("input[name=backend_inputs]"))(Control_Monad_Eff_JQuery.on("change")(function (e) {
              return function (jq) {
                  return function __do() {
                      var v1 = Data_Functor.map(Control_Monad_Eff.functorEff)(function ($146) {
                          return Try_API.getBackendConfigFromString(Data_Maybe.fromMaybe("core")($146));
