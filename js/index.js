...
(function(exports) {
  ...
  var getContT = function (uri) {
      return function (k) {
          return Control_Monad_Eff_Uncurried.runEffFn3($foreign.get)(uri)(Control_Monad_Eff_Uncurried.mkEffFn1(function ($46) {
              return k(Data_Either.Right.create($46));
          }))(Control_Monad_Eff_Uncurried.mkEffFn1(function ($47) {
              return k(Data_Either.Left.create($47));
          }));
      };
  };
  ...
  var ordBackend = new Data_Ord.Ord(function () {
      ...
      return function (y) {
          ...
          throw new Error("Failed pattern match at Main line 172, column 8 - line 172, column 42: " + [ x.constructor.name, y.constructor.name ]);
      };
  });
  var defaultBundleAndExecute = Control_Monad_Eff_Uncurried.mkEffFn2(function (js) {
      return function (v) {
          return Control_Monad_Eff_Uncurried.runEffFn3($foreign.get)(v.endpoint + "/bundle")(Control_Monad_Eff_Uncurried.mkEffFn1(function (bundle) {
              ...
              return Control_Monad_Eff_Console.warn("Unable to load JS bundle: " + err);
          }));
      };
  });
              ...
              return function (v1) {
                  ...
                  return __unused(dictPartial)((function () {
                      if (v1 instanceof Data_Either.Left) {
                          return Control_Monad_Eff_Console.warn("Unable to load JS bundle: " + v1.value0);
                      };
  ...
  var getBackend = function (v) {
      ...
      throw new Error("Failed pattern match at Main line 174, column 1 - line 174, column 39: " + [ v.constructor.name ]);
  };
  var backendToString = function (v) {
      ...
      throw new Error("Failed pattern match at Main line 163, column 1 - line 163, column 37: " + [ v.constructor.name ]);
  };
  var backendFromString = function (dictPartial) {
      return function (v) {
          ...
          return __unused(dictPartial)((function () {
              ...
              throw new Error("Failed pattern match at Main line 155, column 1 - line 155, column 50: " + [ v.constructor.name ]);
          })());
      };
  };
