...
(function(exports) {
      ...
      return function (backend) {
          return function (k) {
              return Control_Monad_Cont_Trans.runContT(Control_Monad_Except_Trans.runExceptT(Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Cont_Trans.monadContT(Control_Monad_Eff.monadEff)))(Try_Gist.getGistById(id_))(function (gi) {
                  ...
                  throw new Error("Failed pattern match at Main line 319, column 5 - line 323, column 40: " + [ v.constructor.name ]);
              });
          };
      };
  };
  var withSession = function (sessionId) {
      return function (k) {
          return function __do() {
              ...
              if (v instanceof Data_Maybe.Nothing) {
                  var v1 = Data_Functor.map(Control_Monad_Eff.functorEff)(function ($161) {
                      return Try_API.getBackendConfigFromString(Data_Maybe.fromMaybe("core")($161));
              ...
              throw new Error("Failed pattern match at Main line 343, column 3 - line 349, column 29: " + [ v.constructor.name ]);
          };
      };
  };
      ...
      return function __do() {
          ...
          return Control_Applicative.when(Control_Monad_Eff.applicativeEff)(v1)(function __do() {
              ...
              return Control_Monad_Cont_Trans.runContT(Control_Monad_Except_Trans.runExceptT(Try_Gist.uploadGist(v2)))(function (v3) {
                  ...
                  throw new Error("Failed pattern match at Main line 383, column 7 - line 389, column 71: " + [ v3.constructor.name ]);
              })();
          })();
      };
  };
  ...
  var displayErrors = function (errs) {
      return function __do() {
          ...
          return Data_FoldableWithIndex.forWithIndex_(Control_Monad_Eff.applicativeEff)(Data_FoldableWithIndex.foldableWithIndexArray)(errs)(function (i) {
              return function (v1) {
                  return Data_Foldable.for_(Control_Monad_Eff.applicativeEff)(Data_Foldable.foldableMaybe)(Data_Newtype.unwrap(Data_Foreign_NullOrUndefined.newtypeNullOrUndefined)(v1.position))(function (v2) {
                      return function __do() {
                          var v3 = Control_Monad_Eff_JQuery.create("<h1>")();
                          Control_Monad_Eff_JQuery.addClass("error-banner")(v3)();
                          Control_Monad_Eff_JQuery.appendText("Error " + (Data_Show.show(Data_Show.showInt)(i + 1 | 0) + (" of " + Data_Show.show(Data_Show.showInt)(Data_Array.length(errs)))))(v3)();
                          var v4 = Control_Monad_Eff_JQuery.create("<pre>")();
                          var v5 = Control_Monad_Eff_JQuery.create("<code>")();
                          Control_Monad_Eff_JQuery.append(v5)(v4)();
                          Control_Monad_Eff_JQuery.appendText(v1.message)(v5)();
                          Control_Monad_Eff_JQuery.append(v3)(v)();
                          return Control_Monad_Eff_JQuery.append(v4)(v)();
                      };
                  });
              };
          })();
                  ...
                  return function __do() {
                      ...
                      if (res_.value0 instanceof Data_Either.Right && res_.value0.value0 instanceof Try_API.CompileSuccess) {
                          ...
                          return Control_Monad_Cont_Trans.runContT(Control_Monad_Except_Trans.runExceptT(v.getBundle))(function (v3) {
                              ...
                              throw new Error("Failed pattern match at Main line 186, column 22 - line 198, column 51: " + [ v3.constructor.name ]);
                          })();
                      };
                      if (res_.value0 instanceof Data_Either.Right && res_.value0.value0 instanceof Try_API.CompileFailed) {
                          ...
                          throw new Error("Failed pattern match at Main line 200, column 13 - line 221, column 53: " + [ res_.value0.value0.value0.error.constructor.name ]);
                      };
                      if (res_.value0 instanceof Data_Either.Left) {
                          displayPlainText("Unable to parse the response from the server")();
                          return Data_Foldable.traverse_(Control_Monad_Eff.applicativeEff)(Data_List_Types.foldableNonEmptyList)(function ($162) {
                              return Control_Monad_Eff_Console.error(Data_Foreign.renderForeignError($162));
                          })(res_.value0.value0)();
                      };
                      throw new Error("Failed pattern match at Main line 180, column 9 - line 224, column 58: " + [ res_.value0.constructor.name ]);
                  };
              };
              throw new Error("Failed pattern match at Main line 175, column 5 - line 224, column 58: " + [ res_.constructor.name ]);
          })();
      };
  };
  ...
  var loadOptions = function (bc) {
      return function __do() {
          ...
          throw new Error("Failed pattern match at Main line 426, column 3 - line 428, column 61: " + [ v3.constructor.name ]);
      };
  };
  ...
  var cacheCurrentCode = function (v) {
      return function __do() {
          ...
          throw new Error("Failed pattern match at Main line 358, column 3 - line 364, column 1: " + [ v1.constructor.name ]);
      };
  };
