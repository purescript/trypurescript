...
(function(exports) {
  ...
  var ffiDep = function (name) {
      ...
      throw new Error("Failed pattern match at Try.Loader line 140, column 3 - line 142, column 81: " + [ v.constructor.name ]);
  };
  ...
  var makeLoader = function (rootPath) {
      ...
      var load = function (v) {
          return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Cont_Trans.monadContT(Effect.monadEffect)))(Effect_Class.liftEffect(Control_Monad_Except_Trans.monadEffectExceptT(Control_Monad_Cont_Trans.monadEffectContT(Effect_Class.monadEffectEffect)))(getModule(v.name)))(function (v1) {
              ...
              if (v1 instanceof Data_Maybe.Nothing) {
                  return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Cont_Trans.monadContT(Effect.monadEffect)))((function () {
                      if (v.path instanceof Data_Maybe.Just) {
                          return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Cont_Trans.monadContT(Effect.monadEffect)))(Try_API.get(rootPath + ("/" + v.path.value0)))(function (v2) {
                              var src = Try_Types.JS(v2 + ("\x0a//@ sourceURL=" + v.path.value0));
                      ...
                      throw new Error("Failed pattern match at Try.Loader line 107, column 11 - line 113, column 62: " + [ v.path.constructor.name ]);
                  })())(function (v2) {
              ...
              throw new Error("Failed pattern match at Try.Loader line 103, column 5 - line 115, column 17: " + [ v1.constructor.name ]);
          });
      };
      var go = function (ms) {
          return function (ffi) {
