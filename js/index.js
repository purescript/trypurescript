...
(function(exports) {
  ...
  var get = function (uri) {
      return function (k) {
          return function () {
              return $foreign.get_(uri, function ($35) {
                  return k(Data_Either.Right.create($35))();
              }, function ($36) {
                  return k(Data_Either.Left.create($36))();
              });
          };
      };
  };
  ...
  var genericCompileError = new Data_Generic_Rep.Generic(function (x) {
      ...
      throw new Error("Failed pattern match at Try.API line 62, column 8 - line 62, column 62: " + [ x.constructor.name ]);
  }, function (x) {
  ...
  var compile = function (endpoint) {
      return function (code) {
          return function (k) {
              return function () {
                  return $foreign.compile_(endpoint, code, function ($37) {
                      return k(Data_Either.Right.create(Control_Monad_Except.runExcept(Foreign_Class.decode(decodeCompileResult)($37))))();
                  }, function ($38) {
                      return k(Data_Either.Left.create($38))();
                  });
              };
          };
      };
...
(function(exports) {
  ...
  var shims = Foreign_Object.fromFoldable(Data_Foldable.foldableArray)([ new Data_Tuple.Tuple("react", {
      shim: "module.exports = window.React;",
      script: "//unpkg.com/react@16.6.3/umd/react.development.js",
      dependencies: [  ]
  }), new Data_Tuple.Tuple("react-dom", {
      shim: "module.exports = window.ReactDOM;",
      script: "//unpkg.com/react-dom@16.6.3/umd/react-dom.development.js",
      dependencies: [ "react" ]
  }), new Data_Tuple.Tuple("react-dom/server", {
      shim: "module.exports = window.ReactDOMServer;",
      script: "//unpkg.com/react-dom@16.6.3/umd/react-dom-server.browser.development.js",
      dependencies: [ "react" ]
  }) ]);
  var resolveShims = (function () {
      var go = function ($copy_accum) {
          return function ($copy_v) {
              ...
              function $tco_loop(accum, v) {
                  ...
                  var shims$prime = Data_Array.mapMaybe(Data_Function.flip(Foreign_Object.lookup)(shims))(v);
                  var names$prime = Control_Bind.bind(Control_Bind.bindArray)(shims$prime)(function (v1) {
                      return v1.dependencies;
                  });
                  var accum$prime = Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Functor.map(Data_Functor.functorArray)(function (v1) {
                      return v1.script;
                  })(shims$prime))(accum);
                  $tco_var_accum = accum$prime;
                  $copy_v = names$prime;
                  return;
              };
              while (!$tco_done) {
      ...
      return function ($5) {
          return Data_Array.nub(Data_Ord.ordString)(go([  ])($5));
      };
  })();
  exports["shims"] = shims;
  exports["resolveShims"] = resolveShims;
})(PS["Try.Shim"] = PS["Try.Shim"] || {});
(function(exports) {
  // Generated by purs version 0.12.0
  "use strict";
  var Control_Applicative = PS["Control.Applicative"];
  ...
  var Try_Shim = PS["Try.Shim"];
  var Try_Types = PS["Try.Types"];
  var runLoader = function (v) {
      return v;
  };
  var requireRegex = Data_String_Regex_Unsafe.unsafeRegex("^var\\s+\\S+\\s*=\\s*require\\([\"']([^\"']*)[\"']\\);")(Data_String_Regex_Flags.noFlags);
  var parseDeps = function (current) {
      var go = function (line) {
          return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_String_Regex.match(requireRegex)(line))(function (v) {
              return Control_Bind.bind(Data_Maybe.bindMaybe)(Control_Bind.join(Data_Maybe.bindMaybe)(Data_Array_NonEmpty.index(v)(1)))(function (v1) {
                  return Control_Applicative.pure(Data_Maybe.applicativeMaybe)((function () {
                      var v2 = Data_String_Common.split("/")(v1);
                      if (v2.length === 2 && (v2[0] === "." && v2[1] === "foreign.js")) {
                          return {
                              name: current + "$Foreign",
                              path: Data_Maybe.Just.create(current + "/foreign.js")
                          };
                      };
                      if (v2.length === 3 && (v2[0] === ".." && v2[2] === "index.js")) {
                          return {
                              name: v2[1],
                              path: Data_Maybe.Just.create(v2[1] + "/index.js")
                          };
                      };
                      return {
                          name: v1,
      ...
      return function ($47) {
          return Data_Array.mapMaybe(go)(Data_String_Common.split("\x0a")(Data_Newtype.unwrap(Try_Types.newtypeJS)($47)));
      };
  };
  var ffiDep = function (name) {
      var v = Foreign_Object.lookup(name)(Try_Shim.shims);
      if (v instanceof Data_Maybe.Just) {
          return v.value0.shim;
      };
      if (v instanceof Data_Maybe.Nothing) {
          return Try_Types.JS("throw new Error('FFI dependency not provided: " + (name + "');"));
      };
      throw new Error("Failed pattern match at Try.Loader line 132, column 3 - line 134, column 81: " + [ v.constructor.name ]);
  };
  var makeLoader = function (rootPath) {
      var moduleCache = Effect_Unsafe.unsafePerformEffect(Effect_Ref["new"](Foreign_Object.empty));
      var putModule = function (a) {
          return function (b) {
              return Effect_Ref.modify_(Foreign_Object.insert(a)(b))(moduleCache);
          };
      };
      var getModule = function (a) {
          return Data_Functor.map(Effect.functorEffect)(Foreign_Object.lookup(a))(Effect_Ref.read(moduleCache));
      };
      var load = function (v) {
          return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Cont_Trans.monadContT(Effect.monadEffect)))(Effect_Class.liftEffect(Control_Monad_Except_Trans.monadEffectExceptT(Control_Monad_Cont_Trans.monadEffectContT(Effect_Class.monadEffectEffect)))(getModule(v.name)))(function (v1) {
              if (v1 instanceof Data_Maybe.Just) {
                  return Control_Applicative.pure(Control_Monad_Except_Trans.applicativeExceptT(Control_Monad_Cont_Trans.monadContT(Effect.monadEffect)))(v1.value0);
              };
              if (v1 instanceof Data_Maybe.Nothing) {
                  return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Cont_Trans.monadContT(Effect.monadEffect)))((function () {
                      if (v.path instanceof Data_Maybe.Just) {
                          return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Cont_Trans.monadContT(Effect.monadEffect)))(Data_Functor.map(Control_Monad_Except_Trans.functorExceptT(Control_Monad_Cont_Trans.functorContT(Effect.functorEffect)))(Try_Types.JS)(Try_API.get(rootPath + ("/" + v.path.value0))))(function (v2) {
                              return Control_Applicative.pure(Control_Monad_Except_Trans.applicativeExceptT(Control_Monad_Cont_Trans.monadContT(Effect.monadEffect)))({
                                  name: v.name,
                                  path: v.path,
                                  deps: parseDeps(v.name)(v2),
                                  src: v2
                              });
                          });
                      };
                      if (v.path instanceof Data_Maybe.Nothing) {
                          return Control_Applicative.pure(Control_Monad_Except_Trans.applicativeExceptT(Control_Monad_Cont_Trans.monadContT(Effect.monadEffect)))({
                              name: v.name,
                              path: v.path,
                              deps: [  ],
                      ...
                      throw new Error("Failed pattern match at Try.Loader line 100, column 11 - line 105, column 62: " + [ v.path.constructor.name ]);
                  })())(function (v2) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Cont_Trans.monadContT(Effect.monadEffect)))(Effect_Class.liftEffect(Control_Monad_Except_Trans.monadEffectExceptT(Control_Monad_Cont_Trans.monadEffectContT(Effect_Class.monadEffectEffect)))(putModule(v.name)(v2)))(function () {
                          return Control_Applicative.pure(Control_Monad_Except_Trans.applicativeExceptT(Control_Monad_Cont_Trans.monadContT(Effect.monadEffect)))(v2);
                      });
                  });
              };
              throw new Error("Failed pattern match at Try.Loader line 96, column 5 - line 107, column 17: " + [ v1.constructor.name ]);
          });
      };
      var go = function (ms) {
          return function (ffi) {
              return function (v) {
                  if (v.length === 0) {
                      return Control_Applicative.pure(Control_Monad_Except_Trans.applicativeExceptT(Control_Monad_Cont_Trans.monadContT(Effect.monadEffect)))({
                          modules: ms,
                          ffiDeps: Try_Shim.resolveShims(ffi)
                      });
                  };
                  return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Cont_Trans.monadContT(Effect.monadEffect)))(Control_Parallel.parTraverse(Control_Parallel_Class.monadParExceptT(Control_Parallel_Class.monadParParCont(Effect_Class.monadEffectEffect)))(Data_Traversable.traversableArray)(load)(v))(function (v1) {
                      var ms$prime = Foreign_Object.union(ms)(Foreign_Object.fromFoldable(Data_Foldable.foldableArray)(Data_Functor.map(Data_Functor.functorArray)(function (v2) {
                          return new Data_Tuple.Tuple(v2.name, v2.src);
                      })(v1)));
                      var ffi$prime = Data_Semigroup.append(Data_Semigroup.semigroupArray)(ffi)(Data_Array.mapMaybe(function (v2) {
                          if (v2.path instanceof Data_Maybe.Nothing) {
                              return new Data_Maybe.Just(v2.name);
                          };
                          return Data_Maybe.Nothing.value;
                      })(v1));
                      return go(ms$prime)(ffi$prime)(Data_Array.nubBy(Data_Ord.comparing(Data_Ord.ordString)(function (v2) {
                          return v2.name;
                      }))(Control_Bind.bindFlipped(Control_Bind.bindArray)(function (v2) {
                          return v2.deps;
                      })(v1)));
                  });
              };
      ...
      return function ($48) {
          return go(Foreign_Object.empty)([  ])(parseDeps("<file>")($48));
      };
  };
  exports["makeLoader"] = makeLoader;
  exports["runLoader"] = runLoader;
})(PS["Try.Loader"] = PS["Try.Loader"] || {});
(function(exports) {
  // Generated by purs version 0.12.0
  "use strict";
  var Control_Monad_Cont = PS["Control.Monad.Cont"];
      ...
      var onComplete = function (dictPartial) {
          return function (v) {
              ...
              return $__unused(dictPartial)((function () {
                  ...
                  throw new Error("Failed pattern match at Try.Backend line 83, column 7 - line 85, column 23: " + [ v.constructor.name ]);
              })());
          };
      };
      var getAll = Control_Parallel.parTraverse(Control_Parallel_Class.monadParExceptT(Control_Parallel_Class.monadParParCont(Effect_Class.monadEffectEffect)))(Data_Traversable.traversableArray)(Try_API.get)([ "js/console.js", "js/react.min.js", "js/react-dom.min.js", endpoint + "/bundle" ]);
  ...
  var getDefaultBundle = function (endpoint) {
      return Data_Functor.map(Control_Monad_Except_Trans.functorExceptT(Control_Monad_Cont_Trans.functorContT(Effect.functorEffect)))(Try_Types.JS)(Try_API.get(endpoint + "/bundle"));
  };
  var getBackendConfig = function (v) {
      if (v instanceof Core) {
          return {
              ...
              extra_styling: "",
              extra_body: "",
              loader: Try_Loader.makeLoader("staging/core/.psci_modules/node_modules"),
              compile: Try_API.compile("http://localhost:8081"),
      ...
      if (v instanceof Thermite) {
          return {
              ...
              loader: Try_Loader.makeLoader("staging/core/.psci_modules/node_modules"),
              compile: Try_API.compile("https://compile.purescript.org/thermite"),
      ...
      if (v instanceof Slides) {
          return {
              ...
              loader: Try_Loader.makeLoader("staging/core/.psci_modules/node_modules"),
              compile: Try_API.compile("https://compile.purescript.org/slides"),
      ...
      if (v instanceof Mathbox) {
          return {
              ...
              extra_body: "",
              loader: Try_Loader.makeLoader("staging/core/.psci_modules/node_modules"),
              compile: Try_API.compile("https://compile.purescript.org/purescript-mathbox"),
      ...
      if (v instanceof Behaviors) {
          return {
              ...
              loader: Try_Loader.makeLoader("staging/core/.psci_modules/node_modules"),
              compile: Try_API.compile("https://compile.purescript.org/behaviors"),
      ...
      if (v instanceof Flare) {
          return {
              ...
              loader: Try_Loader.makeLoader("staging/core/.psci_modules/node_modules"),
              compile: Try_API.compile("https://compile.purescript.org/flare"),
              getBundle: getDefaultBundle("https://compile.purescript.org/flare")
          };
      };
      throw new Error("Failed pattern match at Try.Backend line 95, column 1 - line 95, column 45: " + [ v.constructor.name ]);
  };
  var backendFromString = function (dictPartial) {
      return function (v) {
          ...
          return $__unused(dictPartial)((function () {
              ...
              throw new Error("Failed pattern match at Try.Backend line 46, column 1 - line 46, column 50: " + [ v.constructor.name ]);
          })());
      };
  };
...
(function(exports) {
  ...
  var Prelude = PS["Prelude"];
  var Try_API = PS["Try.API"];
  var Try_Backend = PS["Try.Backend"];
      ...
      return function (backend) {
          return function (k) {
              return Control_Monad_Cont_Trans.runContT(Control_Monad_Except_Trans.runExceptT(Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Cont_Trans.monadContT(Effect.monadEffect)))(Try_Gist.getGistById(id_))(function (gi) {
                  ...
                  throw new Error("Failed pattern match at Main line 232, column 5 - line 236, column 40: " + [ v.constructor.name ]);
              });
          };
      };
  };
      ...
      return function (k) {
          return function __do() {
              ...
              if (v instanceof Data_Maybe.Just) {
                  return k({
                      code: v.value0.code,
                      backend: Try_Backend.getBackendConfigFromString(v.value0.backend)
                  })();
              };
              if (v instanceof Data_Maybe.Nothing) {
                  var v1 = Data_Functor.map(Effect.functorEffect)(function ($137) {
                      return Try_Backend.getBackendConfigFromString(Data_Maybe.fromMaybe("core")($137));
              ...
              throw new Error("Failed pattern match at Main line 244, column 3 - line 250, column 29: " + [ v.constructor.name ]);
          };
      };
  };
      ...
      return function __do() {
          ...
          return Control_Applicative.when(Effect.applicativeEffect)(v1)(function __do() {
              ...
              return Control_Monad_Cont_Trans.runContT(Control_Monad_Except_Trans.runExceptT(Try_Gist.uploadGist(v2)))(function (v3) {
                  ...
                  throw new Error("Failed pattern match at Main line 273, column 7 - line 279, column 71: " + [ v3.constructor.name ]);
              })();
          })();
      };
  };
  ...
  var execute = function (js) {
      return function (modules) {
          return function (ffiDeps) {
              return function (v) {
                  var eventData = {
                      scripts: ffiDeps,
                      sources: Foreign_Object.insert("<file>")(js)(modules)
                  };
                  return function __do() {
                      var v1 = JQuery.select("#column2")();
                      return $foreign.setupIFrame(v1, eventData);
                  };
              };
          };
      };
              ...
              if (res_ instanceof Data_Either.Right) {
                  return function __do() {
                      ...
                      if (res_.value0 instanceof Data_Either.Right && res_.value0.value0 instanceof Try_API.CompileSuccess) {
                          ...
                          return Control_Monad_Cont_Trans.runContT(Control_Monad_Except_Trans.runExceptT(Try_Loader.runLoader(v.loader)(res_.value0.value0.value0.js)))(function (sources) {
                              return function __do() {
                                  hideLoadingMessage();
                                  ...
                                  return Data_Foldable.for_(Effect.applicativeEffect)(Data_Either.foldableEither)(sources)(function (v3) {
                                      return execute(res_.value0.value0.value0.js)(v3.modules)(v3.ffiDeps)(v);
                                  })();
                              };
                          })();
                      };
                      if (res_.value0 instanceof Data_Either.Right && res_.value0.value0 instanceof Try_API.CompileFailed) {
                          ...
                          throw new Error("Failed pattern match at Main line 159, column 13 - line 180, column 53: " + [ res_.value0.value0.value0.error.constructor.name ]);
                      };
                      if (res_.value0 instanceof Data_Either.Left) {
                          hideLoadingMessage();
                          displayPlainText("Unable to parse the response from the server")();
                          return Data_Foldable.traverse_(Effect.applicativeEffect)(Data_List_Types.foldableNonEmptyList)(function ($138) {
                              return Effect_Console.error(Foreign.renderForeignError($138));
                          })(res_.value0.value0)();
                      };
                      throw new Error("Failed pattern match at Main line 138, column 9 - line 184, column 58: " + [ res_.value0.constructor.name ]);
                  };
              };
              throw new Error("Failed pattern match at Main line 133, column 5 - line 184, column 58: " + [ res_.constructor.name ]);
          })();
      };
  };
  ...
  var loadOptions = function (bc) {
      return function __do() {
          ...
          throw new Error("Failed pattern match at Main line 308, column 3 - line 310, column 61: " + [ v3.constructor.name ]);
      };
  };
  ...
  var cacheCurrentCode = function (v) {
      return function __do() {
          ...
          throw new Error("Failed pattern match at Main line 256, column 3 - line 262, column 1: " + [ v1.constructor.name ]);
      };
  };
  ...
  var setupBackendMenu = function (v) {
      return function __do() {
          ...
          return Control_Bind.bind(Effect.bindEffect)(JQuery.select("input[name=backend_inputs]"))(JQuery.on("change")(function (e) {
              return function (jq) {
                  return function __do() {
                      var v1 = Data_Functor.map(Effect.functorEffect)(function ($139) {
                          return Try_Backend.getBackendConfigFromString(Data_Maybe.fromMaybe("core")($139));
