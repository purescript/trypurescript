...
})(PS["Try.Plaste"] = PS["Try.Plaste"] || {});
(function(exports) {
  // Generated by purs version 0.11.7
  "use strict";
  var $foreign = PS["Try.Plaste"];
  var Control_Monad_Cont_Trans = PS["Control.Monad.Cont.Trans"];
  var Control_Monad_Eff = PS["Control.Monad.Eff"];
  var Control_Monad_Eff_Uncurried = PS["Control.Monad.Eff.Uncurried"];
  var Control_Monad_Except_Trans = PS["Control.Monad.Except.Trans"];
  ...
  var Data_Either = PS["Data.Either"];
  var Prelude = PS["Prelude"];        
  var uploadPlaste = function (content) {
      return function (k) {
          return Control_Monad_Eff_Uncurried.runEffFn3($foreign.uploadPlaste_)(content)(Control_Monad_Eff_Uncurried.mkEffFn1(function ($0) {
              return k(Data_Either.Right.create($0));
          }))(Control_Monad_Eff_Uncurried.mkEffFn1(function ($1) {
              return k(Data_Either.Left.create($1));
          }));
  ...
  var getPlasteById = function (id_) {
      return function (k) {
          return Control_Monad_Eff_Uncurried.runEffFn3($foreign.getPlasteById_)(id_)(Control_Monad_Eff_Uncurried.mkEffFn1(function ($2) {
              return k(Data_Either.Right.create($2));
          }))(Control_Monad_Eff_Uncurried.mkEffFn1(function ($3) {
              return k(Data_Either.Left.create($3));
          }));
  ...
  exports["uploadPlaste"] = uploadPlaste;
  exports["getPlasteById"] = getPlasteById;
})(PS["Try.Plaste"] = PS["Try.Plaste"] || {});
(function(exports) {
    "use strict";
...
(function(exports) {
  ...
  var loadFromPlaste = function (id_) {
      return function (backend) {
          return function (k) {
              return Control_Monad_Cont_Trans.runContT(Control_Monad_Except_Trans.runExceptT(Try_Plaste.getPlasteById(id_)))(function (v) {
                  if (v instanceof Data_Either.Left) {
                      return function __do() {
                          Control_Bind.bind(Control_Monad_Eff.bindEff)(DOM_HTML.window)(DOM_HTML_Window.alert(v.value0))();
                          return k({
                              code: "",
                              backend: backend
                          })();
                  ...
                  throw new Error("Failed pattern match at Main line 323, column 5 - line 327, column 40: " + [ v.constructor.name ]);
              });
          };
      };
  };
      ...
      return function (backend) {
          return function (k) {
              return Control_Monad_Cont_Trans.runContT(Control_Monad_Except_Trans.runExceptT(Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Cont_Trans.monadContT(Control_Monad_Eff.monadEff)))(Try_Gist.getGistById(id_))(function (gi) {
                  ...
                  throw new Error("Failed pattern match at Main line 298, column 5 - line 302, column 40: " + [ v.constructor.name ]);
              });
          };
      };
  };
  var withSession = function (sessionId) {
      return function (k) {
          return function __do() {
              ...
              if (v instanceof Data_Maybe.Nothing) {
                  var v1 = Data_Functor.map(Control_Monad_Eff.functorEff)(function ($163) {
                      return Try_API.getBackendConfigFromString(Data_Maybe.fromMaybe("core")($163));
                  })(Try_QueryString.getQueryStringMaybe("backend"))();
                  var v2 = Try_QueryString.getQueryStringMaybe("plaste")();
                  if (v2 instanceof Data_Maybe.Just) {
                      return loadFromPlaste(v2.value0)(v1)(k)();
                  };
                  if (v2 instanceof Data_Maybe.Nothing) {
                      var v3 = Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Maybe.fromMaybe(v1.mainGist))(Try_QueryString.getQueryStringMaybe("gist"))();
                      return loadFromGist(v3)(v1)(k)();
                  };
                  throw new Error("Failed pattern match at Main line 356, column 7 - line 361, column 33: " + [ v2.constructor.name ]);
              };
              throw new Error("Failed pattern match at Main line 350, column 3 - line 361, column 33: " + [ v.constructor.name ]);
          };
      };
  };
  ...
  var hideLoadingMessage = Control_Bind.bind(Control_Monad_Eff.bindEff)(Control_Monad_Eff_JQuery.select("#loading"))(Control_Monad_Eff_JQuery_Extras.fadeOut);
      ...
      return function __do() {
          ...
          return Control_Applicative.when(Control_Monad_Eff.applicativeEff)(v1)(function __do() {
              ...
              return Control_Monad_Cont_Trans.runContT(Control_Monad_Except_Trans.runExceptT(Try_Gist.uploadGist(v2)))(function (v3) {
                  ...
                  throw new Error("Failed pattern match at Main line 395, column 7 - line 401, column 71: " + [ v3.constructor.name ]);
              })();
          })();
      };
  };
  var publishNewPlaste = function (v) {
      return function __do() {
          var v1 = Control_Bind.bind(Control_Monad_Eff.bindEff)(DOM_HTML.window)(DOM_HTML_Window.confirm(Data_Foldable.intercalate(Data_Foldable.foldableArray)(Data_Monoid.monoidString)("\x0a")([ "Do you really want to publish this code at Plaste?", "", "Note: this code will be available to anyone." ])))();
          return Control_Applicative.when(Control_Monad_Eff.applicativeEff)(v1)(function __do() {
              var v2 = getTextAreaContent();
              return Control_Monad_Cont_Trans.runContT(Control_Monad_Except_Trans.runExceptT(Try_Plaste.uploadPlaste(v2)))(function (v3) {
                  if (v3 instanceof Data_Either.Left) {
                      return function __do() {
                          Control_Bind.bind(Control_Monad_Eff.bindEff)(DOM_HTML.window)(DOM_HTML_Window.alert("Failed to create plaste"))();
                          return Control_Monad_Eff_Console.error("Failed to create plaste: " + v3.value0)();
                      };
                  };
                  if (v3 instanceof Data_Either.Right) {
                      return Try_QueryString.setQueryStrings(Data_StrMap.fromFoldable(Data_Foldable.foldableArray)([ new Data_Tuple.Tuple("plaste", v3.value0), new Data_Tuple.Tuple("backend", v.backend) ]));
                  };
                  throw new Error("Failed pattern match at Main line 422, column 7 - line 431, column 16: " + [ v3.constructor.name ]);
              })();
          })();
      };
  };
              ...
              if (res_ instanceof Data_Either.Right) {
                  return function __do() {
                      ...
                      if (res_.value0 instanceof Data_Either.Right && res_.value0.value0 instanceof Try_API.CompileSuccess) {
                          ...
                          return Control_Monad_Cont_Trans.runContT(Control_Monad_Except_Trans.runExceptT(v.getBundle))(function (bundleResult) {
                              return function __do() {
                                  ...
                                  throw new Error("Failed pattern match at Main line 161, column 22 - line 173, column 51: " + [ bundleResult.constructor.name ]);
                              };
                          })();
                      };
                      if (res_.value0 instanceof Data_Either.Right && res_.value0.value0 instanceof Try_API.CompileFailed) {
                          ...
                          throw new Error("Failed pattern match at Main line 176, column 13 - line 197, column 53: " + [ res_.value0.value0.value0.error.constructor.name ]);
                      };
                      if (res_.value0 instanceof Data_Either.Left) {
                          hideLoadingMessage();
                          displayPlainText("Unable to parse the response from the server")();
                          return Data_Foldable.traverse_(Control_Monad_Eff.applicativeEff)(Data_List_Types.foldableNonEmptyList)(function ($164) {
                              return Control_Monad_Eff_Console.error(Data_Foreign.renderForeignError($164));
                          })(res_.value0.value0)();
                      };
                      throw new Error("Failed pattern match at Main line 153, column 9 - line 201, column 58: " + [ res_.value0.constructor.name ]);
                  };
              };
              throw new Error("Failed pattern match at Main line 148, column 5 - line 201, column 58: " + [ res_.constructor.name ]);
          })();
      };
  };
  ...
  var loadOptions = function (bc) {
      return function __do() {
          ...
          var v4 = Try_QueryString.getQueryStringMaybe("plaste")();
          var v5 = new Data_Tuple.Tuple(v3, v4);
          if (v5.value0 instanceof Data_Maybe.Just) {
              Control_Bind.bind(Control_Monad_Eff.bindEff)(Control_Monad_Eff_JQuery.select(".view_gist"))(Control_Monad_Eff_JQuery.attr({
                  href: "https://gist.github.com/" + v5.value0.value0
              }))();
              return Control_Bind.bind(Control_Monad_Eff.bindEff)(Control_Monad_Eff_JQuery.select(".view_plaste_li"))(Control_Monad_Eff_JQuery.hide)();
          };
          if (v5.value1 instanceof Data_Maybe.Just) {
              Control_Bind.bind(Control_Monad_Eff.bindEff)(Control_Monad_Eff_JQuery.select(".view_plaste"))(Control_Monad_Eff_JQuery.attr({
                  href: "https://gathering.purescript.org:7777/" + v5.value1.value0
              }))();
          ...
          Control_Bind.bind(Control_Monad_Eff.bindEff)(Control_Monad_Eff_JQuery.select(".view_plaste_li"))(Control_Monad_Eff_JQuery.hide)();
          return Control_Bind.bind(Control_Monad_Eff.bindEff)(Control_Monad_Eff_JQuery.select(".view_gist_li"))(Control_Monad_Eff_JQuery.hide)();
      };
  };
  var cacheCurrentCode = function (v) {
      return function __do() {
          ...
          throw new Error("Failed pattern match at Main line 370, column 3 - line 376, column 1: " + [ v1.constructor.name ]);
      };
  };
  var setupBackendMenu = function (v) {
      return function __do() {
          ...
          return Control_Bind.bind(Control_Monad_Eff.bindEff)(Control_Monad_Eff_JQuery.select("input[name=backend_inputs]"))(Control_Monad_Eff_JQuery.on("change")(function (e) {
              return function (jq) {
                  return function __do() {
                      var v1 = Data_Functor.map(Control_Monad_Eff.functorEff)(function ($165) {
                          return Try_API.getBackendConfigFromString(Data_Maybe.fromMaybe("core")($165));
  ...
  var setupEditor = function (v) {
      return function __do() {
          ...
          Control_Bind.bind(Control_Monad_Eff.bindEff)(Control_Monad_Eff_JQuery.select("#plaste_save"))(Control_Monad_Eff_JQuery.on("click")(function (e) {
              return function (v1) {
                  return publishNewPlaste(v.backend);
              };
          }))();
          compile(v.backend)();
